...
function getLastStableVersion() {
  ...
  if (!lastStableVersion) {
    throw new Error('unexpected, no stable web3 version?');
  }
...
if (isSlower) {
  console.log('🐢 Using slower web3 build');
}
...
export default async function createConfigAsync() {
  return {
    title: 'web3',
    tagline: 'web and native user interfaces.',
    organizationName: '543x',
    projectName: 'web3',
    baseUrl,
    baseUrlIssueBanner: true,
    url: 'https://i.252x.com',
  ...
  i18n: {
    ...
    plugins: [
      ...
      [
        ...
        {
          blogTitle: 'web and native user interfaces',
          blogDescription:
          ...
          feedOptions: {
            type: 'all',
            title: 'web and native user interfaces',
            description:
              'web and native user interfaces',
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/web3/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/hyaliyun/web3/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/web3/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/web3/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
    ...
    themeConfig: {
        ...
        items: [
...

          {
            ...
            dropdownItemsAfter: [
              ...
              {
                href: 'https://github.com/hyaliyun/web3/issues/2',
                label: 'Help Us Translate',
              },
            ],
          },
          {
            href: 'https://github.com/hyaliyun/web3',
            position: 'right',
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} 543x.com Platforms, Inc.`,
      },
