...
By default, most browser's [user agent stylesheet](/Web/CSS/Cascade#user-agent_stylesheets) will style an {{htmlelement("Heading_Elements", "h1")}} with a large font size to make it _look_ like a heading (although you could style it to look like anything you wanted).
...
HTML should be coded to represent the _data_ that will be populated and not based on its default presentation styling. Presentation (how it should look), is the sole responsibility of [CSS](/Web/CSS).
...
These are _some_ of the roughly 100 semantic [elements](/Web/HTML/Element) available:
...
- [HTML element reference](/Web/HTML/Element#inline_text_semantics) on MDN
- [Using HTML sections and outlines](/Web/HTML/Element/Heading_Elements#usage_notes) on MDN
