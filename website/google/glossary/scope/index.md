...
In addition, identifiers declared with certain syntaxes, including [`let`](/Web/JavaScript/Reference/Statements/let), [`const`](/Web/JavaScript/Reference/Statements/const), [`class`](/Web/JavaScript/Reference/Statements/class), or (in strict mode) [`function`](/Web/JavaScript/Reference/Statements/function), can belong to an additional scope:
...
- [Block scoping rules](/Web/JavaScript/Reference/Statements/block#block_scoping_rules_with_let_const_class_or_function_declaration_in_strict_mode)
