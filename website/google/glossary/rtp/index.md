...
The secure version of RTP, **SRTP**, is used by [WebRTC](/Web/API/WebRTC_API), and uses encryption and authentication to minimize the risk of denial-of-service attacks and security breaches.

RTP is rarely used alone; instead, it is used in conjunction with other protocols like {{glossary("RTSP")}} and {{glossary("SDP")}}.

## See also

- [Introduction to the Real-time Transport Protocol](/Web/API/WebRTC_API/Intro_to_RTP)
