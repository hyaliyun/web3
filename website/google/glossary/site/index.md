...
Browsers sometimes need to distinguish precisely between different sites. For example, the browser must only send [`SameSite`](/Web/HTTP/Headers/Set-Cookie#samesitesamesite-value) cookies to the same site that set them.
