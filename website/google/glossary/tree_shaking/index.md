...
It relies on the [import](/Web/JavaScript/Reference/Statements/import) and [export](/Web/JavaScript/Reference/Statements/export) statements to detect if code modules are exported and imported for use between JavaScript files.
