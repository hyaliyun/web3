...
- Event handlers are now implemented as standard IDL interfaces. For most cases, this won't affect you, but [there are exceptions](/Web/Events/Event_handlers#event_handler_changes_in_firefox_9).
