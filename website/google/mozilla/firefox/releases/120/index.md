...
- The [`103 Early Hints`](/Web/HTTP/Status/103) HTTP [information response](/Web/HTTP/Status#information_responses) status code is enabled for [preconnecting](/Web/HTML/Attributes/rel/preconnect) to a particular origin (that the page is likely to need resources from).
