...
- Support for the [`sandbox`](/Web/HTML/Element/iframe#sandbox) attribute on the {{HTMLElement("iframe")}} element has been added. ([Firefox bug 341604](https://bugzil.la/341604))
...
- [`String`](/Web/JavaScript/Reference/Global_Objects/String) object now offers Harmony [`startsWith`](/Web/JavaScript/Reference/Global_Objects/String/startsWith), [`endsWith`](/Web/JavaScript/Reference/Global_Objects/String/endsWith), and [`contains`](/Web/JavaScript/Reference/Global_Objects/String/includes) methods ([Firefox bug 772733](https://bugzil.la/772733)).
- The String methods [link](/Web/JavaScript/Reference/Global_Objects/String/link) and [anchor](/Web/JavaScript/Reference/Global_Objects/String/anchor) now escape the `'"'` (quotation mark) ([Firefox bug 352437](https://bugzil.la/352437)).
- Experimental support for strawman `ParallelArray` object has been implemented ([Firefox bug 778559](https://bugzil.la/778559)).
- Support to iterate [`Map`](/Web/JavaScript/Reference/Global_Objects/Map)/[`Set`](/Web/JavaScript/Reference/Global_Objects/Set) ([Firefox bug 725909](https://bugzil.la/725909)).
...
- [`for...of`](/Web/JavaScript/Reference/Statements/for...of) loops now work in terms of `.iterator()` and `.next()` ([Firefox bug 725907](https://bugzil.la/725907)).
