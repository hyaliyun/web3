...
- [`<link rel="preload">`](/Web/HTML/Attributes/rel/preload) is now enabled. ([Firefox bug 1626997](https://bugzil.la/1626997)).
...
- The `collation` property can now be specified in the options passed to the [`Intl.Collator()` constructor](/Web/JavaScript/Reference/Global_Objects/Intl/Collator/Collator) ([Firefox bug 1670062](https://bugzil.la/1670062)). This allows developers to write code with greater clarity:
