...
- [Updating web applications for Firefox 3](/Mozilla/Firefox/Releases/3/Updating_web_applications)
...
- [Online and offline events](/Web/API/Navigator/onLine)
  - : Firefox 3 supports WHATWG online and offline events, which let applications and extensions detect whether or not there's an active Internet connection, as well as to detect when the connection goes up and down.
- [Web-based protocol handlers](/Web/API/Navigator/registerProtocolHandler)
  - : You can now register web applications as protocol handlers using the `navigator.registerProtocolHandler()` method.
- [Drawing text using a canvas](/Web/API/Canvas_API/Tutorial/Drawing_text)
  - : You can now draw text in a canvas using a non-standardized API supported by Firefox 3.
- [Transform support for canvas](/Web/API/Canvas_API/Tutorial/Transformations#transforms)
  - : Firefox now supports the `transform()` and `setTransform()` methods on canvases.
- [Using microformats](/Web/HTML/microformats)
  - : Firefox now has APIs for working with microformats.
- [Drag and drop events](/Web/API/HTML_Drag_and_Drop_API)
  - : Firefox 3 supports new events that are sent to the source node for a drag operation when the drag begins and ends.
- [Focus management in HTML](/Web/API/Document/hasFocus)
...
- [DOM improvements in Firefox 3](/Mozilla/Firefox/Releases/3/DOM_improvements)
...
- [JavaScript 1.8 support](/New_in_JavaScript_1.8)
  - : Firefox 3 offers JavaScript 1.8.
- [EXSLT support](/Web/EXSLT)
  - : Firefox 3 provides support for a substantial subset of the [EXSLT](/Web/EXSLT) extensions to [XSLT](/Web/XSLT).
- [SVG improvements in Firefox 3](/Mozilla/Firefox/Releases/3/SVG_improvements)
...
- [Animated PNG graphics](/Web/Media/Formats/Image_types#apng_animated_portable_network_graphics)
...
- [Securing updates](/Extension_Versioning,_Update_and_Compatibility#securing_updates)
...
- [Places migration guide](/Places_Developer_Guide)
  - : An article about how to update an existing extension to use the Places API.
- [Download Manager improvements in Firefox 3](/Download_Manager_improvements_in_Firefox_3)
...
- [Embedding XBL bindings](/XBL/XBL_1.0_Reference/Elements#binding)
...
- [Localizing extension descriptions](/Localizing_extension_descriptions)
...
- [Localization and Plurals](/Localization_and_Plurals)
...
- [Places](/Places)
  - : The history and bookmarks APIs have been completely replaced by the new [Places](/Places) API.
- [Idle service](/nsIIdleService)
...
- [ZIP writer](/nsIZipWriter)
  - : The new `nsIZipWriter` interface lets extensions create ZIP archives.
- [Full page zoom](/Mozilla/Firefox/Releases/3/Full_page_zoom)
  - : Firefox 3 improves the user experience by offering full page zoom in addition to text-only zoom.
- [Interfacing with the XPCOM cycle collector](/Interfacing_with_the_XPCOM_cycle_collector)
...
- [The Thread Manager](/The_Thread_Manager)
...
- [JavaScript modules](/Web/JavaScript/Guide/Modules)
...
- [The `nsIJSON` interface](/nsIJSON)
  - : Firefox 3 offers the new `nsIJSON` interface, which offers high-performance encoding and decoding of [JSON](/Glossary/JSON) strings.
...
- [Using content preferences](/Using_content_preferences)
...
- [Plug-in Monitoring](/Monitoring_plugins)
...
- [Notable bugs fixed in Firefox 3](/Mozilla/Firefox/Releases/3/Notable_bugs_fixed)
