...
> [!WARNING]
> These notes are for developers of screen readers. Developers should use the [ARIA live regions developer documentation](/Web/Accessibility/ARIA/ARIA_Live_Regions).
...
Please read the live region section of the [WAI-ARIA Screen Reader Implementor's Guide](/Web/Accessibility/ARIA/ARIA_Screen_Reader_Implementors_Guide#live_regions).
