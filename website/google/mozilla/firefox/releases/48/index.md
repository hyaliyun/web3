...
- The [`meta`](/Web/HTML/Element/meta) attributes now also supports the `no-referrer-when-downgrade` and `origin-when-cross-origin` values ([Firefox bug 1178337](https://bugzil.la/1178337)).
...
- Several `-webkit` prefixed properties and values have been added for web compatibility, behind the preference `layout.css.prefixes.webkit`, defaulting to `false`:
  ...
  - Added `-webkit-box-flex`, `-webkit-box-ordinal-group`, `-webkit-box-align` and `-webkit-box-pack` properties and `-webkit-box` value to {{cssxref("display")}} as aliases for modern [CSS Flexbox](/Web/CSS/CSS_flexible_box_layout/Typical_use_cases_of_flexbox) ([Firefox bug 1208635](https://bugzil.la/1208635)).
...
- The deprecated [old Proxy API](/Archive/Web/Old_Proxy_API) (`Proxy.create` and `Proxy.createFunction()`) has been removed. Use the standard {{jsxref("Proxy")}} object instead ([Firefox bug 892903](https://bugzil.la/892903)).
...
- The non-standard `RegExp.multiline` property (not {{jsxref("RegExp.prototype.multiline")}}) has been removed. Use the standard [m flag](/Web/JavaScript/Guide/Regular_expressions#advanced_searching_with_flags) instead ([Firefox bug 1219757](https://bugzil.la/1219757)).
- The [`Object.prototype.__defineGetter__()`](/Web/JavaScript/Reference/Global_Objects/Object/__defineGetter__) and [`Object.prototype.__defineSetter__()`](/Web/JavaScript/Reference/Global_Objects/Object/__defineSetter__) methods can no longer be called at the global scope without any object. ([Firefox bug 1253016](https://bugzil.la/1253016)).
...
- The [Web Crypto API](/Web/API/Web_Crypto_API) is now available in [Web workers](/Web/API/Web_Workers_API) ([Firefox bug 842818](https://bugzil.la/842818)).
- The {{domxref("CustomEvent")}} interface is now available in [Web Workers](/Web/API/Web_Workers_API) ([Firefox bug 1003432](https://bugzil.la/1003432)).
...
- The [Social Worker API](/Mozilla/Projects/Social_API/Service_worker_API_reference) has been removed.
- Added the [`-moz-bool-pref()`](/Mozilla/Gecko/Chrome/CSS/-moz-bool-pref) [CSS](/Web/CSS) {{CSSxRef("@supports")}} function to allow hiding portions of chrome stylesheets behind boolean preferences. ([Firefox bug 1259889](https://bugzil.la/1259889))
