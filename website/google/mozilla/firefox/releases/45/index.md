...
- Our implementation of CSS Grids has been improved and is no more considered experimental; it is now activated by default in nightly and developer edition, but not for beta and release ([Firefox bug 1000592](https://bugzil.la/1000592)):
  ...
  - The related feature {{cssxref("display")}}: contents has been supported since [Firefox 37](/Mozilla/Firefox/Releases/37)
...
- ES2015 [Classes](/Web/JavaScript/Reference/Classes) are now enabled by default ([Firefox bug 1197932](https://bugzil.la/1197932)).
...
- For compatibility, the non-standard property [`Node.innerText`](/Web/API/HTMLElement/innerText) has been implemented ([Firefox bug 264412](https://bugzil.la/264412)).
...
- [Web Speech Synthesis API](/Web/API/Web_Speech_API) has been implemented on Firefox Desktop ([Firefox bug 1003439](https://bugzil.la/1003439)).
- The {{domxref("Window/storage_event", "storage")}} event has been added.
- The interface {{domxref("ComputedTiming")}} have been added to our experimental implementation of [Web Animations API](/Web/API/Web_Animations_API) ([Firefox bug 1108055](https://bugzil.la/1108055)).
