...
- Code can now use the new static method [`AbortSignal.abort()`](/Web/API/AbortSignal/abort_static) to return an {{domxref("AbortSignal")}} that is already set as [`aborted`](/Web/API/AbortSignal/aborted) ([Firefox bug 1698468](https://bugzil.la/1698468)).
