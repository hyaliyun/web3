...
- The `x-moz-errormessage` attribute has been removed from the  element ([Firefox bug 1513890](https://bugzil.la/1513890)). You should use the [constraint validation](/Web/HTML/Constraint_validation) API to implement custom validation messages instead.
...
- We've implemented the case-sensitive [attribute selector](/Web/CSS/Attribute_selectors) modifier, `s` ([Firefox bug 1512386](https://bugzil.la/1512386)).
- Several [logical property](/Web/CSS/CSS_logical_properties_and_values) shorthands have landed, along with the flow-relative border radius properties:
