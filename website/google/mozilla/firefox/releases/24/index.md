...
- [Arrow functions](/Web/JavaScript/Reference/Functions/Arrow_functions) are no longer automatically in strict mode unless explicitly requested with `"use strict"` ([Firefox bug 852762](https://bugzil.la/852762)).
- The [`String.prototype.repeat`](/Web/JavaScript/Reference/Global_Objects/String/repeat) JS method has been implemented ([Firefox bug 815431](https://bugzil.la/815431)).
...
- The equal sign ("=") is now [stretchable](/Web/MathML/Element/mo#stretchy).
