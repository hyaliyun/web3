...
This page describes legacy web extension version string formats. See the manifest [version key](/Mozilla/Add-ons/WebExtensions/manifest.json/version) documentation for information on the current version string format.
