...
Instructs the browser to load [content scripts](/Mozilla/Add-ons/WebExtensions/Content_scripts) into web pages whose URL matches a given pattern.
    ...
    <tr>
      ...
      <td>
        ...
        <dl>
          ...
          <dd>
            The default <a href="/Mozilla/Add-ons/WebExtensions/Content_scripts">content scripts</a> execution environment.
...
- `matches`
  - : an array of [match patterns](/Mozilla/Add-ons/WebExtensions/Match_patterns)
- `exclude_matches`
  - : an array of [match patterns](/Mozilla/Add-ons/WebExtensions/Match_patterns)
- `include_globs`
