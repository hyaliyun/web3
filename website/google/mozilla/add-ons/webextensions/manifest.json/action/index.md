...
This key replaces [`browser_action`](/Mozilla/Add-ons/WebExtensions/manifest.json/browser_action) in Manifest V3 extensions.
    ...
    <tr>
      ...
      <td>
        ...
        <div class="notecard warning">
          <p>
            Do not set <code>browser_style</code> to true: its support in Manifest V3 was removed in Firefox 118. See <a href="/Mozilla/Add-ons/WebExtensions/user_interface/Browser_styles#manifest_v3_migration">Manifest V3 migration for <code>browser_style</code></a>.
          </p>
        </div>
      </td>
    </tr>
