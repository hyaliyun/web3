...
Background scripts are loaded as soon as the extension is loaded and stay loaded until the extension is disabled or uninstalled unless `persistent` is specified as `false`. You can use any WebExtension APIs in the script if you have requested the necessary [permissions](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions).

See [Background scripts](/Mozilla/Add-ons/WebExtensions/Background_scripts) for some more details.
...
<table class="standard-table">
  <tbody>
      ...
      <td>
        ...
        <div class="note">
          <p>
            ...
            <code
              ><a
                href="/Mozilla/Add-ons/WebExtensions/manifest.json/content_security_policy"
    ...
    <tr>
      ...
      <td>
        <p>
          Specify a JavaScript file as the extension <a href="/Web/API/Service_Worker_API">service worker</a>. A service worker is a background script that acts as the extension's main event handler.
        </p>
      </td>
    </tr>
  </tbody>
      ...
      <td>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="/Mozilla/Add-ons/WebExtensions/API/storage"
              >storage API</a
            >.
          </li>
        </ul>
