    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          <a href="/Web/HTML/Element/title">&#x3C;title></a> for the
        ...
        <p>
          To override the browser's homepage, use "<a
            href="/Mozilla/Add-ons/WebExtensions/manifest.json/chrome_settings_overrides"
...
All properties are [localizable](/Mozilla/Add-ons/WebExtensions/Internationalization#internationalizing_manifest.json).
