...
A [sidebar](/Mozilla/Add-ons/WebExtensions/user_interface/Sidebars) is a pane that is displayed at the left-hand side of the browser window, next to the web page. The browser provides a UI that enables the user to see the currently available sidebars and to select a sidebar to display.
    ...
    "default_icon": {
      ...
      "32": "path/to/geo-32.png"
        ...
        <p>
          See
          <a
            href="/Mozilla/Add-ons/WebExtensions/manifest.json/browser_action#choosing_icon_sizes"
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          <code
            ><a
              href="/Mozilla/Add-ons/WebExtensions/manifest.json/name"
              >name</a
            ></code
          >.
        </p>
