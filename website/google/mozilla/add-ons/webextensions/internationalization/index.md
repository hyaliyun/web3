...
The [WebExtensions](d-ons/WebExtensions) API has a rather handy module available for internationalizing extensions — [i18n](/Mozilla/Adtensions/API/i18n). In this article we'll explore its features and provide a practical example of how it works. The i18n system for extensions built using WebExtension APIs is similar to common JavaScript libraries for i18n such as [i18n.js](http://i18njs.com/).
...
> [!NOTE]
> You can find much more information about the contents of `messages.json` files in our [Locale-Specific Message reference](d-ons/WebExtensions/API/i18n/Locale-Specific_Message_reference).
...
Another field you should specify in your manifest.json is [default_locale](d-ons/WebExtensions/manifest.json/default_locale):
...
So, you've got your message strings set up, and your manifest. Now you just need to start calling your message strings from JavaScript so your extension can talk the right language as much as possible. The actual [i18n API](d-ons/WebExtensions/API/i18n) is pretty simple, containing just four main methods:
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          the
          <a
            href="d-ons/WebExtensions/manifest.json/browser_specific_settings"
