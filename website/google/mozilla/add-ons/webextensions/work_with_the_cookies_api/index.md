...
To use the Cookies API you need to request both the `"cookies"` permission and [host permissions](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#host_permissions) for the protocols, domains, or websites you want to access or use `"<all_urls>"` to access any protocol and domain. The way in which you define your host permission string affects your extension's ability to read, write, and delete cookies.
...
- [Cookies API reference](/Mozilla/Add-ons/WebExtensions/API/cookies).
