...
Your extension can include user interface elements - browser and page action [popups](/Mozilla/Add-ons/WebExtensions/user_interface/Popups), [sidebars](/Mozilla/Add-ons/WebExtensions/user_interface/Sidebars), and [options pages](/Mozilla/Add-ons/WebExtensions/user_interface/Options_pages) - that are specified by:

1. creating an HTML file defining the structure of the UI element.
2. adding a manifest.json key ([`action`](/Mozilla/Add-ons/WebExtensions/manifest.json/action), [`browser_action`](/Mozilla/Add-ons/WebExtensions/manifest.json/browser_action), [`page_action`](/Mozilla/Add-ons/WebExtensions/manifest.json/page_action), [`sidebar_action`](/Mozilla/Add-ons/WebExtensions/manifest.json/sidebar_action), or [`options_ui`](/Mozilla/Add-ons/WebExtensions/manifest.json/options_ui)) pointing to that HTML file.
...
<table class="fullwidth-table standard-table">
  ...
  <tbody>
    <tr>
      <td>
        <code
          ><a href="/Web/HTML/Element/button">&#x3C;button></a></code
        >
      </td>
      <td>
...
&#x3C;button class="browser-style">Click me&#x3C;/button></pre
    ...
    <tr>
      <td>
        <p>
          <code
            ><a href="/Web/HTML/Element/select"
              >&#x3C;select></a
            ></code
          >
        </p>
...
&#x3C;/select></pre
    ...
    <tr>
      <td>
        <code
          ><a href="/Web/HTML/Element/textarea"
            >&#x3C;textarea></a
          ></code
        >
      </td>
...
&#x3C;textarea class="browser-style">Write here&#x3C;/textarea></pre
    ...
    <tr>
      <td>
        Parent of an
        <code
          ><a href="/Web/HTML/Element/input">&#x3C;input></a></code
        >
      </td>
      <td>
        <pre class="brush: html">
