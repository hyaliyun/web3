...
To use this method, an extension must request the "theme" [permission](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions) in its [manifest.json](/Mozilla/Add-ons/WebExtensions/manifest.json) file.
