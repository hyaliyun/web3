...
A [`Promise`](/Web/JavaScript/Reference/Global_Objects/Promise) that will be fulfilled with an [array](/Web/JavaScript/Reference/Global_Objects/Array) of search engine objects. Each search engine object may contain the following properties:
