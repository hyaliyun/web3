...
Your extension should specify an icon for the sidebar in the [`sidebar_action`](/Mozilla/Add-ons/WebExtensions/manifest.json/sidebar_action) manifest key. This is called the _"manifest icon"_.
