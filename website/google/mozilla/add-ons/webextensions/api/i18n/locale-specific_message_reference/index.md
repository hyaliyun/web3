...
> [!NOTE]
> For information on how to internationalize your extensions, see our [i18n](/Mozilla/Add-ons/WebExtensions/Internationalization) guide.
...
> [!NOTE]
> You shouldn't define names that start with @@. Such names are reserved for [predefined messages](/Mozilla/Add-ons/WebExtensions/Internationalization#predefined_messages).
