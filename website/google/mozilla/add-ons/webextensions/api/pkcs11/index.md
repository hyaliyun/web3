...
To use this API you need to have the "pkcs11" [permission](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions).
...
- For each installed `PKCS #11` module, there must be a [native manifest](/Mozilla/Add-ons/WebExtensions/Native_manifests) file that enables the browser to locate the module.
...
For details about the manifest file's contents and location, see [Native manifests](/Mozilla/Add-ons/WebExtensions/Native_manifests).
