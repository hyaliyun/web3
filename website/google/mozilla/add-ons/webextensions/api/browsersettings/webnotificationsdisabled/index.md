...
A {{WebExtAPIRef("types.BrowserSetting", "BrowserSetting")}} object that can be used to prevent websites from showing notifications using the [`Notifications`](/Web/API/Notifications_API) Web API.
...
Note that this setting has no effect on notifications created by extensions using the [`notifications`](/Mozilla/Add-ons/WebExtensions/API/notifications) API.
