...
- `data`
  - : [`Uint8Array`](/Web/JavaScript/Reference/Global_Objects/Uint8Array) or [`ArrayBuffer`](/Web/JavaScript/Reference/Global_Objects/ArrayBuffer): array of bytes containing the data to pass to the browser's rendering engine.
