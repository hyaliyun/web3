...
An event handler called repeatedly when response data is available. The handler is passed an [`Event` object](/Web/API/Event) with a `data` property. The `data` property includes a chunk of the response data as an {{jsxref("ArrayBuffer")}}.
