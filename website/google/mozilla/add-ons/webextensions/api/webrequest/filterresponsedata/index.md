...
To use this API, you must have the `"webRequest"` and `"webRequestBlocking"` [API permissions](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#api_permissions), and for the event listener, the [host permission](/Mozilla/Add-ons/WebExtensions/manifest.json/permissions#host_permissions) for the host. In addition:
