...
The **`grow`** [memory instruction](/WebAssembly/Reference/Memory) increases the size of the memory instance by a specified number of pages.
...
> **Note:** `grow` support in Wasm modules matches the grow support in the JavaScript [`Memory.grow()`](/WebAssembly/JavaScript_interface/Memory/grow) API.
