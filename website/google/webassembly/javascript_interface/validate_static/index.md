...
The **`WebAssembly.validate()`** static method validates a given [typed array](/Web/JavaScript/Guide/Typed_arrays) of WebAssembly binary
...
- `bufferSource`
  - : A [typed array](/Web/JavaScript/Guide/Typed_arrays) or [ArrayBuffer](/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)
...
If `bufferSource` is not a [typed array](/Web/JavaScript/Guide/Typed_arrays) or [ArrayBuffer](/Web/JavaScript/Reference/Global_Objects/ArrayBuffer),
