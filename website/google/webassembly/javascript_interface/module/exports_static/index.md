...
[`WebAssembly.compileStreaming()`](/WebAssembly/JavaScript_interface/compileStreaming_static) method and then sends it to a [worker](/Web/API/Web_Workers_API) using [postMessage()](/Web/API/Worker/postMessage).
...
instance from it using the [`WebAssembly.Instantiate()`](/WebAssembly/JavaScript_interface/instantiate_static) method, invoke an
