...
The **`WebAssembly.Tag()`** constructor creates a new [`WebAssembly.Tag`](/WebAssembly/JavaScript_interface/Tag) object.
...
- `type`
  ...
  - : An object that can contain the following members:
    ...
    - `parameters`
      - : An array of [data types](/WebAssembly/Understanding_the_text_format#types) (`"i32"`, `"i64"`, `"f32"`, `"f64"`, `"v128"`, `"externref"`, `"anyfunc"`).
