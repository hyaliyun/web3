...
The **`grow()`** prototype method of the [`WebAssembly.Memory`](/WebAssembly/JavaScript_interface/Memory) object increases the size of the memory instance by a specified number of WebAssembly pages.
