...
- [`WebAssembly.Table()`](/WebAssembly/JavaScript_interface/Table/Table)
  - : Creates a new `Table` object.

## Instance properties

- [`Table.prototype.length`](/WebAssembly/JavaScript_interface/Table/length) {{ReadOnlyInline}}
  - : Returns the length of the table, i.e. the number of elements in the table.

## Instance methods

- [`Table.prototype.get()`](/WebAssembly/JavaScript_interface/Table/get)
  - : Accessor function — gets the element stored at a given index.
- [`Table.prototype.grow()`](/WebAssembly/JavaScript_interface/Table/grow)
  - : Increases the size of the `Table` instance by a specified number of elements.
- [`Table.prototype.set()`](/WebAssembly/JavaScript_interface/Table/set)
...
The following example (see table2.html [source code](https://github.com/mdn/webassembly-examples/blob/main/js-api-examples/table2.html) and [live version](https://mdn.github.io/webassembly-examples/js-api-examples/table2.html)) creates a new WebAssembly Table instance with an initial size of 2 elements. We then print out the table length and contents of the two indexes (retrieved via [`Table.prototype.get()`](/WebAssembly/JavaScript_interface/Table/get) to show that the length is two and both elements are [`null`](/Web/JavaScript/Reference/Operators/null).
...
Finally, we load and instantiate a Wasm module (table2.wasm) using the [`WebAssembly.instantiateStreaming()`](/WebAssembly/JavaScript_interface/instantiateStreaming_static) method. The table2.wasm module contains two functions (one that returns 42 and another that returns 83) and stores both into elements 0 and 1 of the imported table (see [text representation](https://github.com/mdn/webassembly-examples/blob/main/js-api-examples/table2.wat)). So after instantiation, the table still has length 2, but the elements now contain callable [Exported WebAssembly Functions](/WebAssembly/Exported_functions) which we can call from JS.
