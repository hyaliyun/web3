...
The read-only **`length`** prototype property of the [`WebAssembly.Table`](/WebAssembly/JavaScript_interface/Table) object returns the length of the table, i.e. the number of elements in the table.
