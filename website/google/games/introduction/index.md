...
- [HTML audio](/Web/HTML/Element/audio)
  - : The {{HTMLElement("audio")}} element lets you easily play simple sound effects and music. If your needs are more involved, check out the [Web Audio API](/Web/API/Web_Audio_API) for real audio processing power!
