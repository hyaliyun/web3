...
- Participating in community discussions on the [communication channels](/MDN/Community/Communication_channels).
...
- Addressing open issues (for example, in the [`content`](https://github.com/mdn/content/issues) repository) by submitting [pull requests](/MDN/Community/Pull_requests).
...
<!--
TODO: Compare with https://developer.mozilla.org/MDN/Community/Roles_teams#volunteer_and_partner_maintainers.
...
- Suggesting, documenting, and implementing new policies through the [pull request process](/MDN/Community/Pull_requests).
...
Their contributions are in the form of pull requests to improve the project, helping community members on various [communication channels](/MDN/Community/Communication_channels) or learn forums, or providing feedback on GitHub issues and pull requests.
...
- Monitoring all the [communication channels](/MDN/Community/Communication_channels).
