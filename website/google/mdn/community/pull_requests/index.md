...
When it comes to the changes in a pull request, content and prose must adhere to the [MDN Writing style guide](/MDN/Writing_guidelines/Writing_style_guide) and example code must follow the [code style guide](/MDN/Writing_guidelines/Writing_style_guide/Code_style_guide).
...
- **Don't merge pull requests that have failing tests.**
  It is good [open source etiquette](/MDN/Community/Open_source_etiquette) to keep the `main` branch stable to avoid disruption for contributors, maintainers, and for automated processes.
  ...
  If you are not sure how to fix the failing tests, [ask for help](/MDN/Community/Communication_channels) or assign the pull request to someone else.
