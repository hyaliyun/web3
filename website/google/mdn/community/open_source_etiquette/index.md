...
You could also contribute by opening [pull requests](/MDN/Community/Pull_requests) to fix problems that you come across while reading MDN articles.
...
Good OSPs will always make contributor documentation readily available. On GitHub projects, it is usually in the repo's CONTRIBUTING.md file, or sometimes in the project's README.md file. Being a documentation project, MDN content has a [README](https://github.com/mdn/content/blob/main/README.md) and a decent set of contributor docs on the site itself (see [Contributing to MDN Web Docs](/MDN/Community/Contributing)).
