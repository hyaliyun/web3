...
If you want to get a team together to work on an update, or you just want to report or discuss some content needing an update, feel free to [file a content issue](https://github.com/mdn/content/issues) or [ask us for help](ity/Communication_channels).
...
For the complete list of page types see [The page-type front matter key](g_guidelines/Page_structures/Page_types/Page_type_key).
...
- [API landing page template](g_guidelines/Page_structures/Page_types/API_landing_page_template)
...
- [Request interface](quest) of the [Fetch API](/Web/API/Fe

#### Templates

- [API reference page template](g_guidelines/Page_structures/Page_types/API_reference_page_template)
...
- [`count()` method](BIndex/count) of the [IDBIndex](/Web/API/IDerface (part of the [IndexedDB API](/Web/API/IndexedDB_API
- [capabilities property](Display/capabilities) of the [VRDisplay](/Web/API/VRterface (part of the [WebVR API](/Web/API/WebVR_API))
- [Request() constructor](quest/Request) of the [Request](/Web/API/Rerface (part of the [Fetch API](/Web/API/Fetch_API))
- [vrdisplaypresentchange event](ndow/vrdisplaypresentchange_event) (part of the [WebVR API](/Web/API/Weangs off the [Window](/Web/API/Window)) inte

#### Templates

- [API method subpage template](g_guidelines/Page_structures/Page_types/API_method_subpage_template)
- [API property subpage template](g_guidelines/Page_structures/Page_types/API_property_subpage_template)
- [API constructor subpage template](g_guidelines/Page_structures/Page_types/API_constructor_subpage_template)
- [API event subpage template](g_guidelines/Page_structures/Page_types/API_event_subpage_template)
...
- [`<video>` element](lement/video)

#### Templates

- [HTML element page template](g_guidelines/Page_structures/Page_types/HTML_element_page_template)
...
- [SVG element page template](g_guidelines/Page_structures/Page_types/SVG_element_page_template)

### CSS module landing page

Every **[CSS](odule** represents a CSS specification that provides support for certain features and implementations in CSS. For example, the [CSS box model](/Web/CSS/CS) module represents the [specification](/Web/CSS/CSS_box_modelions) that describes the margin and padding properties that let you create spacing in and around a CSS box.
...
For example, the `<easing-function>` data type and the `prefers-reduced-motion` media query are not covered in the CSS animations module, but because they are closely related with CSS animations, it is a good idea to highlight them in the [Related concepts](S_animations#related_concepts) section of the CSS animations module landing page.

#### Examples

- [CSS animations](S_animations)
- [CSS basic user interface](S_basic_user_interface)
- [CSS filter effects](S_filter_effects)
- [CSS scroll snap](S_scroll_snap)

#### Templates

- [CSS module landing page template](g_guidelines/Page_structures/Page_types/CSS_module_landing_page_template)
...
- [background-color property](ckground-color)
- [:hover pseudo-class](over)
- [@media at-rule](edia)

#### Templates

- [CSS property page template](g_guidelines/Page_structures/Page_types/CSS_property_page_template)
- [CSS selector page template](g_guidelines/Page_structures/Page_types/CSS_selector_page_template)
- [CSS function page template](g_guidelines/Page_structures/Page_types/CSS_function_page_template)
...
- [Cache-Control header](eaders/Cache-Control)

#### Templates

- [HTTP header page template](g_guidelines/Page_structures/Page_types/HTTP_header_page_template)
...
- [Using the WebVR API](bVR_API/Using_the_WebVR_API)
- [Visualizations with Web Audio API](b_Audio_API/Visualizations_with_Web_Audio_API)
- [Cascade and inheritance in CSS](Building_blocks/Cascade_and_inheritance)
...
If the page grows to more than a screenful or so, it's too long and should be converted to a conceptual page. See [How to write and reference an entry in the glossary](g_guidelines/Howto/Write_a_new_entry_in_the_glossary) for more details.
...
- [Glossary page template](g_guidelines/Page_structures/Page_types/Glossary_page_template)
...
- [JavaScript](ript)
- [Learning area](
- [Contributing to MDN](ity/Contributing)

## See also

- [Page components](g_guidelines/Writing_style_guide#page_components)
- [Creating code examples in markdown](g_guidelines/Writing_style_guide/Code_style_guide)
