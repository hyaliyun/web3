...
>     For example, the [`<video>`](/Web/HTML/Element/video) element has a _title_ of: **'\<video>: The Video Embed element'**.
> - **slug**
...
>     For example, the [`<video>`](/Web/HTML/Element/video) element has a _slug_ of `Web/HTML/Element/video`.
> - **page-type**
>   - : Always `html-element`.
> - **status**
...
The **`<insert_the_element_name>`** [HTML](/Web/HTML) element does _(insert a summary paragraph naming the element and saying what it does, ideally one or two short sentences)_.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/Web/Accessibility/ARIA/Roles/directory_role"><code>directory</code></a>.
      </td>
    </tr>
    <tr>
