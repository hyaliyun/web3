...
>     For example, the [count()](/Web/API/IDBIndex/count) method of the [IDBIndex](/Web/API/IDBIndex) interface has a _title_ of `IDBIndex: count() method`.
> - **slug**
>
...
Fill in a syntax box, according to the guidance in our [syntax sections](/MDN/Writing_guidelines/Page_structures/Syntax_sections) article.
