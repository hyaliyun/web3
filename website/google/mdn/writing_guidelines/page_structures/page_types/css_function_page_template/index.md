...
>     For example, the [`pow()`](/Web/CSS/pow) function has a title of _pow()_.
> - **slug**
>   - : The `slug` value is the end of the URL path after `https://developer.mozilla.org/`. This will be formatted as `Web/CSS/NameOfTheFunction`. Note the absence of parentheses in the slug.
>     For example, the slug for the [`pow()`](/Web/CSS/pow) function is `Web/CSS/pow`.
> - **page-type**
...
Include links to reference pages and guides related to the current function. For more guidelines, see the [See also section](/MDN/Writing_guidelines/Writing_style_guide#see_also_section) in the _Writing style guide_.
