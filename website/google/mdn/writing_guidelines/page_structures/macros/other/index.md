...
In contrast to the macros listed in [Commonly-used macros](/MDN/Writing_guidelines/Page_structures/Macros/Commonly_used_macros), the macros documented in this article are used infrequently or only in specific contexts, or are deprecated.
...
We have one macro specifically designed to create [lists of links](/MDN/Writing_guidelines/Page_structures/Sidebars) within content:
