...
Macros on MDN are implemented using server-executed [JavaScript](/Web/JavaScript) code, interpreted using [Node.js](https://nodejs.org/en/).
...
You can read up on our most commonly used macros on the [Commonly used macros](/MDN/Writing_guidelines/Page_structures/Macros/Commonly_used_macros) page; also, you can browse through the [complete sources for all macros](https://github.com/mdn/yari/tree/main/kumascript/macros). Most of the macro sources have documentation built into them, as comments at the top.
