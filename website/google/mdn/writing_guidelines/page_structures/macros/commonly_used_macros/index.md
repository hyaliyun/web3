...
For additional how-to information on using these macros, see [Using macros](/MDN/Writing_guidelines/Page_structures/Macros).

See [Other macros](/MDN/Writing_guidelines/Page_structures/Macros/Other) for information on macros that are infrequently used, are used only in special contexts, or are deprecated.
...
The [`Glossary`](https://github.com/mdn/yari/blob/main/kumascript/macros/Glossary.ejs) macro creates a link to a specified term's entry in the MDN [glossary](/Glossary).
...
<table class="standard-table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="/Web/CSS/Reference">CSS Reference</a> (/Web/CSS/Reference)
      </td>
      <td>
    ...
    <tr>
      ...
      <td><a href="/Web/API">DOM Reference</a> (/Web/API)</td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/HTML/Element">HTML Elements reference</a> (/Web/HTML/Element)
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/JavaScript/Reference">JavaScript reference</a> (/Web/JavaScript/Reference).
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/SVG/Attribute">SVG attribute reference</a> (/Web/SVG/Attribute).
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/SVG/Attribute">SVG Element reference</a> (/Web/SVG/Element).
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/HTTP/Headers">HTTP headers</a> (/Web/HTTP/Headers).
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/HTTP/Methods">HTTP request methods</a> (/Web/HTTP/Methods).
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/HTTP/Status">HTTP response status codes</a> (/Web/HTTP/Status)
      </td>
      <td>
...
- [`EmbedLiveSample`](https://github.com/mdn/yari/blob/main/kumascript/macros/EmbedLiveSample.ejs) lets you embed the output of a code sample on a page, as described in [Live samples](/MDN/Writing_guidelines/Page_structures/Live_samples).
- [`LiveSampleLink`](https://github.com/mdn/yari/blob/main/kumascript/macros/LiveSampleLink.ejs) creates a link to a page containing the output of a code sample on a page, as described in [Live samples](/MDN/Writing_guidelines/Page_structures/Live_samples).
- [`EmbedGHLiveSample`](https://github.com/mdn/yari/blob/main/kumascript/macros/EmbedGHLiveSample.ejs) allows to embed live samples from GitHub pages.
  You can get more information at [GitHub live samples](/MDN/Writing_guidelines/Page_structures/Code_examples#github_live_samples).
...
For more information on the definition **experimental**, see the [Experimental, deprecated, and obsolete](/MDN/Writing_guidelines/Experimental_deprecated_obsolete) documentation.
...
For more information on the definition **deprecated**, see the [Experimental, deprecated, and obsolete](/MDN/Writing_guidelines/Experimental_deprecated_obsolete) documentation.
...
- [`SeeCompatTable`](https://github.com/mdn/yari/blob/main/kumascript/macros/SeeCompatTable.ejs) used on pages
  that document [experimental features](/MDN/Writing_guidelines/Experimental_deprecated_obsolete#experimental).
  Example: `\{{SeeCompatTable}}` {{SeeCompatTable}}
- [`deprecated_header`](https://github.com/mdn/yari/blob/main/kumascript/macros/Deprecated_Header.ejs): `\` 
...
The [`AvailableInWorkers`](https://github.com/mdn/yari/blob/main/kumascript/macros/AvailableInWorkers.ejs) macro inserts a localized note box indicating that a feature is available in a [Web worker](/Web/API/Web_Workers_API) context.
...
- `\{{Compat}}` / `\{{Compat(&lt;feature>)}}` / `\{{Compat(&lt;feature>, &lt;depth>)}}`
  ...
  - : Generates a [compatibility table](/MDN/Writing_guidelines/Page_structures/Compatibility_tables) for the feature passed as the parameter. If no parameter is included, it defaults to the features defined by `browser-compat` in the frontmatter. An optional depth parameter sets how deep sub features should be added to the table. The depth, if omitted, defaults to 1, meaning only the first level of sub feature data from BCD will be included.
...
- [Sidebar macros](/MDN/Writing_guidelines/Page_structures/Sidebars)
...
- [Feature status macros](/MDN/Writing_guidelines/Page_structures/Feature_status)
