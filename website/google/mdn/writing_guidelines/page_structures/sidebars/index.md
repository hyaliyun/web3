...
The frontmatter is the content between the dashes. The sidebar macro is included immediately after the frontmatter. The `\` is a sidebar macro that adds the MDN sidebar to the page. When the sidebar is a single macro call, the macro is placed immediately after the frontmatter.
...
- `\`
  ...
  - : Generates the sidebar for [HTTP documentation](/Web/HTTP), including guides and reference docs.
...
The appropriate macro to use depends on the [page type](/MDN/Writing_guidelines/Page_structures/Page_types). The [template](/MDN/Writing_guidelines/Page_structures/Page_types#page_templates) for each page type includes the appropriate macro for that page type.
...
1. [**Accessibility**](/Web/Accessibility)

   \{{ListSubpagesForSidebar("/Web/Accessibility")}}

2. [**ARIA roles**](/Web/Accessibility/ARIA/Roles)

   \{{ListSubpagesForSidebar("/Web/Accessibility/ARIA/Roles", "true")}}

3. [**ARIA attributes**](/Web/Accessibility/ARIA/Attributes)

   \{{ListSubpagesForSidebar("/Web/Accessibility/ARIA/Attributes", "true")}}
...
- [Content link macros](/MDN/Writing_guidelines/Page_structures/Links)
- [Page section macros](/MDN/Writing_guidelines/Page_structures/Macros/Commonly_used_macros)
- [Banners and notices macros](/MDN/Writing_guidelines/Page_structures/Banners_and_notices)
