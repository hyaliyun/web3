...
For more information on these terms, see the ["Experimental, deprecated, and obsolete"](/MDN/Writing_guidelines/Experimental_deprecated_obsolete) page.
...
To show status icons for a feature listed in sidebars, the [front-matter](/MDN/Writing_guidelines/Page_structures/Page_types/CSS_function_page_template#sect1) `status` property is used:
...
- [Link macros](/MDN/Writing_guidelines/Page_structures/Links)
