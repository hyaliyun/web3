...
This article explains how to add and link to entries in the [MDN Web Docs glossary](/Glossary).
...
If you're looking for topics that need a glossary entry, check the list of terms in the sidebar of the [Glossary landing page](/Glossary).

If you have an idea for a new glossary entry, [create a new page](/MDN/Writing_guidelines/Howto/Creating_moving_deleting#creating_pages) for it underneath the [glossary landing page](https://github.com/mdn/content/tree/main/files/en-us/glossary).
...
If you aren't sure where to put your article, feel free to [reach out to discuss it](/MDN/Community/Discussions).
...
1. The page [Glossary/Signature](/Glossary/Signature) is the disambiguation page with the [`GlossaryDisambiguation`](https://github.com/mdn/yari/blob/main/kumascript/macros/GlossaryDisambiguation.ejs) macro.
2. The page [Glossary/Signature/Security](/Glossary/Signature/Security) is the page defining a signature in a security context.
3. The page [Glossary/Signature/Function](/Glossary/Signature/Function) is the page defining a function signature.
