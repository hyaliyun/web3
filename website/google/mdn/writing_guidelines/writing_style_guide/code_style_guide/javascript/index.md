...
When adding items to an array, use [`push()`](/Web/JavaScript/Reference/Global_Objects/Array/push) and not direct assignment. Consider the following array:
...
- [Promises](/Web/JavaScript/Reference/Global_Objects/Promise)
- [`async`](/Web/JavaScript/Reference/Statements/async_function)/[`await`](/Web/JavaScript/Reference/Operators/await)
...
- When using arrow functions, use [implicit return](/Web/JavaScript/Reference/Functions/Arrow_functions#function_body) (also known as _expression body_) when possible:
...
When [loops](/Learn/JavaScript/Building_blocks/Looping_code) are required, choose the appropriate one from [`for(;;)`](/Web/JavaScript/Reference/Statements/for), [`for...of`](/Web/JavaScript/Reference/Statements/for...of), [`while`](/Web/JavaScript/Reference/Statements/while), etc.
...
> [!NOTE]
> Consider not using a `for` loop at all. If you are using an [`Array`](/Web/JavaScript/Reference/Global_Objects/Array) (or a [`String`](/Web/JavaScript/Reference/Global_Objects/String) for some operations), consider using more semantic iteration methods instead, like [`map()`](/Web/JavaScript/Reference/Global_Objects/Array/map), [`every()`](/Web/JavaScript/Reference/Global_Objects/Array/every), [`findIndex()`](/Web/JavaScript/Reference/Global_Objects/Array/findIndex), [`find()`](/Web/JavaScript/Reference/Global_Objects/Array/find), [`includes()`](/Web/JavaScript/Reference/Global_Objects/Array/includes), and many more.
...
- If certain states of your program throw uncaught errors, they will halt execution and potentially reduce the usefulness of the example. You should, therefore, catch errors using a [`try...catch`](/Web/JavaScript/Reference/Statements/try...catch) block, as shown below:
...
- The [`Object.prototype.hasOwnProperty()`](/Web/JavaScript/Reference/Global_Objects/Object/hasOwnProperty) method has been deprecated in favor of [`Object.hasOwn()`](/Web/JavaScript/Reference/Global_Objects/Object/hasOwn).
...
When you want to store to a variable a literal value depending on a condition, use a [conditional (ternary) operator](/Web/JavaScript/Reference/Operators/Conditional_operator) instead of an `if...else` statement. This rule also applies when returning a value. Write:
...
Prefer the [strict equality](/Web/JavaScript/Reference/Operators/Strict_equality) (triple equals) and inequality operators over the loose equality (double equals) and inequality operators.
...
For inserting values into strings, use [template literals](/Web/JavaScript/Reference/Template_literals).
...
When declaring variables and constants, use the [`let`](/Web/JavaScript/Reference/Statements/let) and [`const`](/Web/JavaScript/Reference/Statements/const) keywords, not [`var`](/Web/JavaScript/Reference/Statements/var). The following examples show what's recommended and what's not on MDN Web Docs:
...
- The `alert()` function is unreliable. It doesn't work in live examples on MDN Web Docs that are inside an {{HTMLElement("iframe")}}. Moreover, it is modal to the whole window, which is annoying. In static code examples, use `console.log()` or `console.error()`. In [live examples](/MDN/Writing_guidelines/Page_structures/Live_samples), avoid `console.log()` and `console.error()` because they are not displayed. Use a dedicated UI element.
...
[JavaScript language reference](/Web/JavaScript/Reference) - browse through our JavaScript reference pages to check out some good, concise, meaningful JavaScript snippets.
