...
The guidelines described in this article apply to the styling and formatting of code examples, irrespective of the language. For guidelines about what content to include while writing the code examples, see the [writing style guide](/MDN/Writing_guidelines/Writing_style_guide#code_examples).

For technology-specific guidelines, see the following articles:

- [HTML guidelines](/MDN/Writing_guidelines/Writing_style_guide/Code_style_guide/HTML)
- [CSS guidelines](/MDN/Writing_guidelines/Writing_style_guide/Code_style_guide/CSS)
- [JavaScript guidelines](/MDN/Writing_guidelines/Writing_style_guide/Code_style_guide/JavaScript)
- [Shell prompt guidelines](/MDN/Writing_guidelines/Writing_style_guide/Code_style_guide/Shell)
