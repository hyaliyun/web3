...
This is aimed at larger projects. To suggest a new page or article, please refer to the [Suggesting content](/MDN/Writing_guidelines/What_we_write#suggesting_content) section on the "What we write" page.
...
If a technology looks like a good candidate for being documented on MDN Web Docs, you can start a discussion on the [GitHub community discussions](/MDN/Community/Communication_channels#github_discussions) to propose and discuss the inclusion of this technology. This section describes what the proposal should include.
...
These [guidelines](/MDN/Writing_guidelines) state how we expect documents to be written for MDN Web Docs.
...
Please refer to our section on [page types](/MDN/Writing_guidelines/Page_structures/Page_types). If additions need to be made, please liaise with your MDN Web Docs representative.
