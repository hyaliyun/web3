...
- IMSC uses [namespaces](/Related/IMSC/Namespaces), so that `tts:fontSize` is not the same as `fontSize`, and namespace declarations are required, like
...
IMSC is unrelated to [WebVTT](/Web/API/WebVTT_API), which is another way of making subtitles and captions for the Web.
...
- [IMSC basics](/Related/IMSC/Basics)
...
- [Using the imscJS polyfill](/Related/IMSC/Using_the_imscJS_polyfill)
...
- [Styling IMSC documents](/Related/IMSC/Styling)
...
- [Subtitle placement in IMSC](/Related/IMSC/Subtitle_placement)
...
- [Namespaces in IMSC](/Related/IMSC/Namespaces)
...
- [Timing in IMSC](/Related/IMSC/Timing_in_IMSC)
...
- [Mapping video time codes to IMSC](/Related/IMSC/Mapping_video_time_codes_to_IMSC)
...
- [IMSC and other standards](/Related/IMSC/IMSC_and_other_standards)
