...
This has the effect that pointer events are going "through" the overlay (see [reference documentation for point events](/Web/CSS/pointer-events) for more details).
...
the best solution is to building your own custom controls. Find out how in our [Creating a cross-browser video player](/Web/Media/Audio_and_video_delivery/cross_browser_video_player) tutorial.
