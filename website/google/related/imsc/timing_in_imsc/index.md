...
If you have not already read the [IMSC document with timing](/Related/IMSC/Basics#timing) section in the [IMSC basics](/Related/IMSC/Basics) article, you should do so now and then return here — it contains an initial overview of how to describe timing events.
...
> [!NOTE]
> You can find an additional explanation of these values in [Mapping video time codes to IMSC](/Related/IMSC/Mapping_video_time_codes_to_IMSC).
