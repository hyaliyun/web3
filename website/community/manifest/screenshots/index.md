...
- `sizes`
  - : String that describes the size of the image, or multiple sizes for image formats such as ICO that can contain multiple images. This property is equivalent to, and specified in the same way as, the [`sizes`](/Web/HTML/Element/link#sizes) attribute of the {{htmlelement("link")}} element.
- `src`
