...
- [tabindex](/Web/HTML/Global_attributes/tabindex) global HTML attribute
- Element: [keydown event](/Web/API/Element/keydown_event)
- Element: [keyup event](/Web/API/Element/keyup_event)
...
Any element that can receive keyboard focus should have visible styling that indicates when the element is focused. You can do this with the [`:focus`](/Web/CSS/:focus) and [`:focus-visible`](/Web/CSS/:focus-visible) CSS pseudo-classes.
