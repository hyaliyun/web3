  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        way to achieve this is to set the <a href="/Web/HTML/Global_attributes#lang">lang</a>
      ...
      <td>
        See
        <a
          href="/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML#setting_the_primary_language_of_the_document"
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          <a href="/Web/HTML/Global_attributes#lang">lang</a> attribute on an element wrapped
    ...
    <tr>
      ...
      <td>
        ...
        <a
          href="/Learn/HTML/Introduction_to_HTML/Advanced_text_formatting#description_lists"
          >description list</a
        >
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          ...
          takes a <a href="/Web/HTML/Global_attributes#title">title</a> attribute that contains the
      ...
      <td>
        See
        <a
          href="/Learn/HTML/Introduction_to_HTML/Advanced_text_formatting#abbreviations"
          >Abbreviations</a
        >.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        See
        <a
          href="/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content"
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a
          href="/Learn/Accessibility/HTML#building_keyboard_accessibility_back_in"
    ...
    <tr>
      ...
      <td>
        See
        <a href="/Learn/Accessibility/HTML#page_layouts"
          >Page layouts</a
        >
        for information on modern markup for layouts. See also
        <a
          href="/Learn/CSS/Styling_text/Styling_links#styling_links_as_buttons"
    ...
    <tr>
      ...
      <td>
        ...
        form labels. See
        <a href="/Learn/Accessibility/HTML#meaningful_text_labels"
...
<table class="standard-table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        See
        <a href="/Learn/Forms/Form_validation"
          >Form data validation</a
        >
        for comprehensive validation information, and
        <a
          href="/Learn/Accessibility/WAI-ARIA_basics#dynamic_content_updates"
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <a
              href="/Learn/Accessibility/HTML#meaningful_text_labels"
              >Meaningful text labels</a
            >
          </li>
          <li>
            <a href="/Learn/Forms/How_to_structure_a_web_form"
              >How to structure an HTML form</a
            >
          </li>
          <li>
            <a
              href="/Web/Accessibility/Understanding_WCAG/Text_labels_and_names"
    ...
    <tr>
      ...
      <td>
        <p>
          ...
          <a href="/Learn/Server-side/Django">Django web framework</a
          >).
        </p>
        <p>
