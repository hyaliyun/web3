...
The `aria-colspan` attribute defines the number of columns spanned by a cell or gridcell within a [`table`](/Web/Accessibility/ARIA/Roles/table_role), [`grid`](/Web/Accessibility/ARIA/Roles/grid_role), or [`treegrid`](/Web/Accessibility/ARIA/Roles/treegrid_role).

## Description

Intended for [`cell`s](/Web/Accessibility/ARIA/Roles/cell_role) and [`gridcell`s](/Web/Accessibility/ARIA/Roles/gridcell_role) which are not contained in a native HTML {{HTMLElement('table')}}, the `aria-colspan` property value defines the number of columns spanned by an individual cell an ARIA [`table`](/Web/Accessibility/ARIA/Roles/table_role), [`grid`](/Web/Accessibility/ARIA/Roles/grid_role), or [`treegrid`](/Web/Accessibility/ARIA/Roles/treegrid_role).

In HTML, {{HTMLElement('th')}} and {{HTMLElement('td')}} elements have the [`colspan`](/Web/HTML/Element/td#attributes) attribute. When using the semantic {{HTMLElement('table')}}, use the native `colspan` attribute as designed. This ARIA attribute is intended for cells and gridcells which are not contained in a native table, and will be ignored if used on a cell in a {{HTMLElement('table')}}.
...
- {{domxref("Element.ariaColSpan")}}
  - : The [`ariaColSpan`](/Web/API/Element/ariaColSpan) property, part of each element's interface, reflects the value of the `aria-colspan` attribute, which defines the number of columns spanned by a cell or gridcell within a table, grid, or treegrid.
...
- The {{HTMLElement('th')}} and {{HTMLElement('td')}} [`colspan`](/Web/HTML/Element/td#attributes) attribute
- [`aria-colindex`](/Web/Accessibility/ARIA/Attributes/aria-colindex) property
- [`aria-rowspan`](/Web/Accessibility/ARIA/Attributes/aria-rowspan) property
- [`cell`](/Web/Accessibility/ARIA/Roles/cell_role) role
- [`columnheader`](/Web/Accessibility/ARIA/Roles/columnheader_role) role
- [`rowheader`](/Web/Accessibility/ARIA/Roles/columnheader_role) role
