...
- {{domxref("Element.ariaSort")}}
  - : The [`ariaSort`](ement/ariaSort) property, part of the {{domxref("Element")}} interface, reflects the value of the `aria-sort` attribute.
- {{domxref("ElementInternals.ariaSort")}}
  - : The [`ariaSort`](ementInternals/ariaSort) property, part of the {{domxref("ElementInternals")}} interface, reflects the value of the `aria-sort` attribute.
...
- [`aria-pressed`](ibility/ARIA/Attributes/aria-pressed)
