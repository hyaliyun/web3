...
If you want all the contents of the live region to be read, use the [`aria-atomic`](/Web/Accessibility/ARIA/Attributes/aria-atomic). Use [`aria-relevant`](/Web/Accessibility/ARIA/Attributes/aria-relevant) to define only the sections of an update that need to be reread to the user. Use [`aria-busy`](/Web/Accessibility/ARIA/Attributes/aria-busy) to prevent announcements while updates are still being made.
...
- {{domxref("Element.ariaLive")}}
  - : The [`ariaLive`](/Web/API/Element/ariaLive) property, part of the {{domxref("Element")}} interface, reflects the value of the `aria-live` attribute.
- {{domxref("ElementInternals.ariaLive")}}
  - : The [`ariaLive`](/Web/API/ElementInternals/ariaLive) property, part of the {{domxref("ElementInternals")}} interface, reflects the value of the `aria-live` attribute.
...
- [`alert` role](/Web/Accessibility/ARIA/Roles/alert_role)
