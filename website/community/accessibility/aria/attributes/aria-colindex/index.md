...
Used in conjunction with the [`aria-colcount`](/Web/Accessibility/ARIA/Attributes/aria-colcount) attribute, which informs assistive technologies how many columns the table would have if all columns were present, the `aria-colindex` is used an element's column index or position with respect to that total number of columns.
...
The following example shows a grid with 6 columns, of which columns 1, 2, 5, and 6 are displayed to the user. The total number of columns that make up the table is set as `aria-colcount="6"` on the table itself. As the columns aren't contiguous, every [`cell`](/Web/Accessibility/ARIA/Roles/cell_role) - in this case [`columnheader`](/Web/Accessibility/ARIA/Roles/columnheader_role) and [`gridcell`](/Web/Accessibility/ARIA/Roles/gridcell_role) elements - have the `aria-colindex` attribute set.
...
- {{domxref("Element.ariaColIndex")}}
  - : The [`ariaColIndex`](/Web/API/Element/ariaColIndex) property, part of the {{domxref("Element")}} interface, reflects the value of the `aria-colindex` attribute.
- {{domxref("ElementInternals.ariaColIndex")}}
  - : The [`ariaColIndex`](/Web/API/ElementInternals/ariaColIndex) property, part of the {{domxref("ElementInternals")}} interface, reflects the value of the `aria-colindex` attribute.
...
- [`aria-colindextext`](/Web/Accessibility/ARIA/Attributes/aria-colindextext) attribute
- [`aria-colcount`](/Web/Accessibility/ARIA/Attributes/aria-colcount) attribute
- [`aria-colspan`](/Web/Accessibility/ARIA/Attributes/aria-colspan) attribute
