...
Adding `aria-pressed` to an element with a role of [`button`](/Web/Accessibility/ARIA/Roles/button_role) turns the button into a toggle button. The `aria-pressed` attribute is only relevant for toggle buttons. It represents the button's current "pressed" state.
...
- {{domxref("Element.ariaPressed")}}
  - : The [`ariaPressed`](/Web/API/Element/ariaPressed) property, part of the {{domxref("Element")}} interface, reflects the value of the `aria-pressed` attribute.
- {{domxref("ElementInternals.ariaPressed")}}
  - : The [`ariaPressed`](/Web/API/ElementInternals/ariaPressed) property, part of the {{domxref("ElementInternals")}} interface, reflects the value of the `aria-pressed` attribute.
...
- [`<input type="button">`](/Web/HTML/Element/input/button)
- [`<input type="submit">`](/Web/HTML/Element/input/submit)
- {{HTMLElement('button')}}
