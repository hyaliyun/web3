...
Cell elements have the role [`gridcell`](/Web/Accessibility/ARIA/Roles/gridcell_role), unless they are a row or column header. Then the elements are [`rowheader`](/Web/Accessibility/ARIA/Roles/rowheader_role) and [`columnheader`](/Web/Accessibility/ARIA/Roles/columnheader_role), respectively. Cell elements need to be owned by elements with a [`row`](/Web/Accessibility/ARIA/Roles/row_role) role. Rows can be grouped using `rowgroups`.
...
- [treegrid](/Web/Accessibility/ARIA/Roles/treegrid_role) (subclass)
...
- [rowgroup](/Web/Accessibility/ARIA/Roles/rowgroup_role)
  - : A group containing one or multiple [row](/Web/Accessibility/ARIA/Roles/row_role)s.
...
- [aria-readonly](/Web/Accessibility/ARIA/Attributes/aria-readonly)
  - : If the user can navigate the grid but not change the value or values of the grid, the [`aria-readonly`](/Web/Accessibility/ARIA/Attributes/aria-readonly) should be set to `true`. The default value is `false`.
...
- [ARIA `treegrid` role](/Web/Accessibility/ARIA/Roles/treegrid_role)
