...
For HTML, use the {{HTMLElement('figure')}} and {{HTMLElement('figcaption')}} elements. The figcaption will serve as the accessible name for the figure. When not using HTML, or when retrofitting legacy HTML, use the [`aria-labelledby`](/Web/Accessibility/ARIA/Attributes/aria-labelledby) on the figure, pointing to the figure's caption.
If there is no visible caption, [`aria-label`](/Web/Accessibility/ARIA/Attributes/aria-label) can be used.
...
- Use [`aria-describedby`](/Web/Accessibility/ARIA/Attributes/aria-describedby) when the text is a longer description.
- Use [`aria-label`](/Web/Accessibility/ARIA/Attributes/aria-label) when there is no visible figure caption.
...
- [HTML `<figure>` element](/Web/HTML/Element/figure)
- [HTML `<figcaption>` element](/Web/HTML/Element/figcaption)
