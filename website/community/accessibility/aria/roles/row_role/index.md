...
An element with `role="row"` is a row of cells within a tabular structure. A row contains one or more cells, grid cells or column headers, and possibly a row header, within a [`grid`](/Web/Accessibility/ARIA/Roles/grid_role), [`table`](/Web/Accessibility/ARIA/Roles/table_role) or [`treegrid`](/Web/Accessibility/ARIA/Roles/treegrid_role), and optionally within a [`rowgroup`](/Web/Accessibility/ARIA/Roles/rowgroup_role).
...
The element `role="row"` is a row within a [`grid`](/Web/Accessibility/ARIA/Roles/grid_role), [`table`](/Web/Accessibility/ARIA/Roles/table_role) or [`treegrid`](/Web/Accessibility/ARIA/Roles/treegrid_role), and optionally within a [`rowgroup`](/Web/Accessibility/ARIA/Roles/rowgroup_role), that is a container for one or more [`cells`](/Web/Accessibility/ARIA/Roles/cell_role), [`gridcells`](/Web/Accessibility/ARIA/Roles/gridcell_role), [`columnheaders`](/Web/Accessibility/ARIA/Roles/columnheader_role), or [`rowheaders`](/Web/Accessibility/ARIA/Roles/rowheader_role) within a static tabular structure. Using native [HTML `<tr>`](/Web/HTML/Element/tr) elements, whenever possible, is strongly encouraged.
...
A row can contain a number of attributes clarifying the row's role, including [`aria-colindex`](/Web/Accessibility/ARIA/Attributes/aria-colindex), [`aria-level`](/Web/Accessibility/ARIA/Attributes/aria-level), [`aria-rowindex`](/Web/Accessibility/ARIA/Attributes/aria-rowindex), and [`aria-selected`](/Web/Accessibility/ARIA/Attributes/aria-selected).

If the row is within a treegrid, rows can include the [`aria-expanded`](/Web/Accessibility/ARIA/Attributes/aria-expanded) attribute, using the attribute to indicate the present status. This is not the case for an ordinary table or grid, in which the `aria-expanded` attribute is not present.
...
- [role="rowgroup"](/Web/Accessibility/ARIA/Roles/rowgroup_role)
...
- [role="table"](/Web/Accessibility/ARIA/Roles/table_role)
...
- [role="grid"](/Web/Accessibility/ARIA/Roles/grid_role)
...
- [role="treegrid"](/Web/Accessibility/ARIA/Roles/treegrid_role)
  - : Similar to a grid, but with rows that can be expanded and collapsed in the same manner as for a tree.

#### Descendant roles

- [role="cell"](/Web/Accessibility/ARIA/Roles/cell_role)
  - : A cell in a row within a tabular container.
- [role="gridcell"](/Web/Accessibility/ARIA/Roles/gridcell_role)
  - : A cell in a row within a grid or treegrid.
- [role="columnheader"](/Web/Accessibility/ARIA/Roles/columnheader_role)
...
- [role="rowheader"](/Web/Accessibility/ARIA/Roles/rowheader_role)
...
- [`aria-expanded`](/Web/Accessibility/ARIA/Attributes/aria-expanded) state
...
- [`aria-selected`](/Web/Accessibility/ARIA/Attributes/aria-selected) state
...
- [`aria-colindex`](/Web/Accessibility/ARIA/Attributes/aria-colindex) attribute
...
- [`aria-rowindex`](/Web/Accessibility/ARIA/Attributes/aria-rowindex) attribute
...
Above is the semantic way of writing a table. The ARIA roles are only necessary if the native semantics of the table, and therefore the table rows, are obliterated, such as via setting the [display property to flex or grid](/Web/CSS/display#accessibility).
...
- {{HTMLElement('table')}}
- [The `rowgroup` role](/Web/Accessibility/ARIA/Roles/rowgroup_role)
- [The `table` role](/Web/Accessibility/ARIA/Roles/table_role)
- [The `grid` role](/Web/Accessibility/ARIA/Roles/grid_role)
- [The `treegrid` role](/Web/Accessibility/ARIA/Roles/treegrid_role)
- [The `cell` role](/Web/Accessibility/ARIA/Roles/cell_role)
- [The `gridcell` role](/Web/Accessibility/ARIA/Roles/gridcell_role)
- [The `columnheader` role](/Web/Accessibility/ARIA/Roles/columnheader_role)
- [The `rowheader` role](/Web/Accessibility/ARIA/Roles/rowheader_role)
