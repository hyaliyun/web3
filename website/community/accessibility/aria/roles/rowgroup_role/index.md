...
An element with `role="rowgroup"` is a group of [rows](/Web/Accessibility/ARIA/Roles/row_role) within a tabular structure. A `rowgroup` contains one or more rows of [cells](/Web/Accessibility/ARIA/Roles/cell_role), [grid cells](/Web/Accessibility/ARIA/Roles/gridcell_role), [column headers](/Web/Accessibility/ARIA/Roles/columnheader_role), or [row headers](/Web/Accessibility/ARIA/Roles/rowheader_role) within a [`grid`](/Web/Accessibility/ARIA/Roles/grid_role), [`table`](/Web/Accessibility/ARIA/Roles/table_role) or [`treegrid`](/Web/Accessibility/ARIA/Roles/treegrid_role).
...
- [role="row"](/Web/Accessibility/ARIA/Roles/row_role)
  - : A row of cells within a tabular structure. A row contains one or more [cells](/Web/Accessibility/ARIA/Roles/cell_role), [gridcell](/Web/Accessibility/ARIA/Roles/gridcell_role), or [column headers](/Web/Accessibility/ARIA/Roles/columnheader_role), and sometimes a [row header](/Web/Accessibility/ARIA/Roles/rowheader_role).
...
Above is the semantic way of writing a table. The ARIA roles are only necessary if the native semantics of the table, and therefore the table rows, are obliterated, such as by setting the [display property to flex or grid](/Web/CSS/display#accessibility).
...
- [HTML table](/Web/HTML/Element/table)
- [HTML table body](/Web/HTML/Element/tbody)
- [HTML table footer](/Web/HTML/Element/tfoot)
- [HTML table header](/Web/HTML/Element/thead)
