...
This page illustrates the application of CSS to the specialized language for creating graphics: [SVG](/Web/SVG).

Below you'll create a simple demonstration that runs in your SVG-enabled browser.

> [!NOTE]
> Elements referenced by {{SVGElement("use")}} elements inherit the styles from that element. So to apply different styles to them you should use [CSS custom properties](/Web/CSS/CSS_cascading_variables).
...
[See a solution to this challenge.](/Web/Guide/CSS/Getting_started/Challenge_solutions#svg_and_css)
