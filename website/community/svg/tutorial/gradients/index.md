...
> ```
>
> I've included the xlink namespace here directly on the node, although usually you would define it at the top of your document. More on that when we [talk about images](/Web/SVG/Tutorial/Other_content_in_SVG).
...
You can also then apply another transformation to the gradient by using the `gradientTransform` attribute, but since we haven't [introduced transforms](/Web/SVG/Tutorial/Basic_Transformations) yet, I'll leave that for later.
