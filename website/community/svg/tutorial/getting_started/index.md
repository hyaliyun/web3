...
1. We start with the {{SVGElement("svg")}} root element:
   ...
   - As an XML dialect, SVG must always bind the namespaces correctly (in the xmlns attribute). See the [Namespaces Crash Course](/Web/SVG/Namespaces_Crash_Course) page for more info.
...
- How SVG handles sizes and units will be explained [on the next page](/Web/SVG/Tutorial/Positions).
