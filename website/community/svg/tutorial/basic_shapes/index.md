...
For this reason, [the next section](/Web/SVG/Tutorial/Paths) in this tutorial will be focused on paths. But for now, note that there is a single parameter used to control its shape.
...
- `d`
  - : A list of points and other information about how to draw the path. See the [Paths](/Web/SVG/Tutorial/Paths) section for more information.
