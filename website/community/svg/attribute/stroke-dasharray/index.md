...
- \<dasharray>
  ...
  - : A list of comma and/or white space separated [`<length>`](/Web/SVG/Content_type#length)s and [`<percentage>`](/Web/SVG/Content_type#percentage)s that specify the lengths of alternating dashes and gaps.
