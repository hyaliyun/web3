...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <strong><a href="/Web/CSS/string">&#x3C;string></a></strong>
      </td>
    </tr>
    <tr>
...
The property takes either [`path()`](/Web/CSS/basic-shape/path) or `none`.
...
_Cubic [Bézier curves](/Glossary/Bezier_curve)_ are smooth curve definitions using four points:
...
_Quadratic [Bézier curves](/Glossary/Bezier_curve)_ are smooth curve definitions using three points:
