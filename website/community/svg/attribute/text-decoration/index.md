...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <code
          ><a href="/Web/CSS/text-decoration-line"
            >&#x3C;'text-decoration-line'></a
          ></code
        >
        ||
        <code
          ><a href="/Web/CSS/text-decoration-style"
            >&#x3C;'text-decoration-style'></a
          ></code
        >
        ||
        <code
          ><a href="/Web/CSS/text-decoration-color"
...
For a description of the values, please refer to the [CSS `text-decoration`](/Web/CSS/text-decoration#values) property.
