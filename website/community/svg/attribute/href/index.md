...
The **`href`** attribute defines a link to a resource as a reference [URL](/Web/SVG/Content_type#url). The exact meaning of that link depends on the context of each element using it.
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <code
          ><a href="/Web/SVG/Content_type#url">&#x3C;url></a></code
        >
      </td>
    </tr>
    <tr>
...
For {{SVGElement("mpath")}}, `href` defines a URL referring to the {{SVGElement("path")}} element or [basic shape](/Web/CSS/CSS_shapes/Basic_shapes) which defines the motion path.
...
For {{SVGElement("textPath")}}, `href` defines a URL referring to the {{SVGElement("path")}} element or [basic shape](/Web/CSS/CSS_shapes/Basic_shapes) onto which the text will be rendered if no {{SVGAttr("path")}} attribute is provided. On the {{SVGElement("textPath")}} element, the `href` attribute is animatable.
