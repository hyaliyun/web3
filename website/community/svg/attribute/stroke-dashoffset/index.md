...
The offset is usually expressed in user units resolved against the {{SVGAttr('pathLength')}} but if a [\<percentage>](/Web/SVG/Content_type#percentage) is used, the value is resolved as a percentage of the current viewport.
