  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <code
          ><a href="/Web/SVG/Content_type#icccolor"
            >&#x3C;icccolor></a
          ></code
        >
      </td>
...
- `currentcolor`
  - : This keyword denotes the current fill color and can be specified in the same manner as within a [`<paint>`](/Web/SVG/Content_type#paint) specification for the {{SVGAttr("fill")}} and {{SVGAttr("stroke")}} attributes.
- `<color>`
