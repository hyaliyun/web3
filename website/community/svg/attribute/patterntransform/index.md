...
The **`patternTransform`** attribute defines a list of [transform definitions](/Web/SVG/Attribute/transform#transform_functions) that are applied to a pattern tile.
...
For {{SVGElement('pattern')}}, `patternTransform` defines a list of [transform definitions](/Web/SVG/Attribute/transform#transform_functions) that are applied to a pattern tile.
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <a href="/Web/SVG/Attribute/transform#transform_functions"
          >&#x3C;transform-list></a
        >
      </td>
    </tr>
