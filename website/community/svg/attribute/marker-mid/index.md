...
The **`marker-mid`** attribute defines the arrowhead or polymarker that will be drawn at all interior vertices of the given [shape](/Web/SVG/Element#shape_elements).

The marker is rendered on every vertex other than the first and last vertices of the [path data](/Web/SVG/Attribute/d#path_commands).

> [!NOTE]
> As a presentation attribute, `marker-mid` can be used as a CSS property. See {{cssxref('marker-mid')}} for more.
