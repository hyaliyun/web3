...
> [!NOTE]
> As a presentation attribute, `color` can be used as a CSS property. See [CSS color](/Web/CSS/color) for further information.
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <code><a href="/Web/CSS/color_value">&#x3C;color></a></code>
        | <code>inherit</code>
      </td>
    </tr>
    <tr>
