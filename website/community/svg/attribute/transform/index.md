...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <strong
          ><a href="/Web/SVG/Content_type#transform-list"
...
> [!WARNING]
> As per the spec, you should be able to also use CSS [transform functions](/Web/CSS/transform-function). However, the compatibility isn't guaranteed.
