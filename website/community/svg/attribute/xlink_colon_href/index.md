...
The **`xlink:href`** attribute defines a reference to a resource as a reference [IRI](/Web/SVG/Content_type#iri). The exact meaning of that link depends on the context of each element using it.
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <code
          ><a href="/Web/SVG/Content_type#iri">&#x3C;iri></a></code
        >
      </td>
    </tr>
    <tr>
...
<table class="properties">
  <tbody>
    <tr>
      ...
      <td>
        <code
          ><a href="/Web/SVG/Content_type#funciri"
            >&#x3C;funciri></a
          ></code
        >
      </td>
