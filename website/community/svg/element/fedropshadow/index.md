...
- {{SVGAttr("dx")}}
  - : This attribute defines the x offset of the drop shadow.
    _Value type_: [**\<number>**](/Web/SVG/Content_type#number); _Default value_: `2`; _Animatable_: **yes**
- {{SVGAttr("dy")}}
...
- {{SVGAttr("stdDeviation")}}
  - : This attribute defines the standard deviation for the blur operation in the drop shadow.
    _Value type_: [**\<number-optional-number>**](/Web/SVG/Content_type#number-optional-number); _Default value_: `2`; _Animatable_: **yes**
...
- [SVG Filter primitive attributes](/Web/SVG/Attribute#filters_attributes) including {{SVGAttr('height')}}, {{SVGAttr('in')}}, {{SVGAttr('result')}}, {{SVGAttr('x')}}, {{SVGAttr('y')}}, and {{SVGAttr('width')}}.
- [SVG presentation attributes](/Web/SVG/Attribute#presentation_attributes), including {{SVGAttr('flood-color')}}, and {{SVGAttr('flood-opacity')}}.
