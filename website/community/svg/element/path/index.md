...
The **`<path>`** [SVG](/Web/SVG) element is the generic element to define a shape. All the basic shapes can be created with a path element.
...
- [The MDN SVG "Getting Started" tutorial: Path](/Web/SVG/Tutorial/Paths)
