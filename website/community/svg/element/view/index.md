...
The `<view>` SVG element defines a particular view of an SVG document. A specific view can be displayed by referencing the `<view>` element's [`id`](/Web/HTML/Global_attributes/id) as the target fragment of a URL.
