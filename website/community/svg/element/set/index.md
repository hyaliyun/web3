...
- {{SVGAttr("to")}}
  - : This attribute defines the value to be applied to the target attribute for the duration of the animation. The value must match the requirements of the target attribute.
    _Value type_: [**\<anything>**](/Web/SVG/Content_type#anything); _Default value_: none; _Animatable_: **no**
...
- [Animation timing attributes](/Web/SVG/Attribute#animation_timing_attributes), including {{SVGAttr("begin")}}, {{SVGAttr("dur")}}, {{SVGAttr("end")}}, {{SVGAttr("min")}}, {{SVGAttr("max")}}, {{SVGAttr("restart")}}, {{SVGAttr("repeatCount")}}, {{SVGAttr("repeatDur")}}, and {{SVGAttr("fill")}}.
- {{SVGElement("animate")}}
