...
- {{SVGAttr("path")}} {{Experimental_Inline}}
  - : The path on which the text should be rendered.
    _Value type_: [**\<path_data>**](/Web/SVG/Attribute/path#path-data) ; _Default value_: none; _Animatable_: **yes**
...
- {{SVGAttr("startOffset")}}
  - : How far the beginning of the text should be offset from the beginning of the path.
    _Value type_: [**\<length>**](/Web/SVG/Content_type#length)|[**\<percentage>**](/Web/SVG/Content_type#percentage)|[**\<number>**](/Web/SVG/Content_type#number) ; _Default value_: `0`; _Animatable_: **yes**
- {{SVGAttr("textLength")}}
  - : The width of the space into which the text will render.
    _Value type_: [**\<length>**](/Web/SVG/Content_type#length)|[**\<percentage>**](/Web/SVG/Content_type#percentage)|[**\<number>**](/Web/SVG/Content_type#number) ; _Default value_: _auto_; _Animatable_: **yes**
