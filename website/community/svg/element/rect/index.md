...
The **`<rect>`** element is a [basic SVG shape](/Web/SVG/Tutorial/Basic_Shapes) that draws rectangles, defined by their position, width, and height. The rectangles may have their corners rounded.
...
- {{SVGAttr("width")}}
  - : The width of the rect.
    _Value type_: `auto`|[**\<length>**](/Web/SVG/Content_type#length)|[**\<percentage>**](/Web/SVG/Content_type#percentage) ; _Default value_: `auto`; _Animatable_: **yes**
- {{SVGAttr("height")}}
