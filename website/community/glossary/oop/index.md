...
{{glossary("JavaScript")}} is heavily object-oriented. It follows a [**prototype**-based model](/Web/JavaScript/Inheritance_and_the_prototype_chain), but it also offers a [class syntax](/Web/JavaScript/Guide/Using_classes) to enable typical OOP paradigms.
