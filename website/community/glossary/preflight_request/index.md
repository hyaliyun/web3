...
A preflight request is automatically issued by a browser and in normal cases, front-end developers don't need to craft such requests themselves. It appears when request is qualified as ["to be preflighted"](/Web/HTTP/CORS#preflighted_requests) and omitted for [simple requests](/Web/HTTP/CORS#simple_requests).
