...
- [Web media technologies](/Web/Media): a guide to all the ways media can be used in web content
- [Multimedia and Embedding](/Learn/HTML/Multimedia_and_embedding) in the MDN learning area
