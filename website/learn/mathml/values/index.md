...
In addition to [CSS data types](/Web/CSS/CSS_Types), some MathML attributes accept the following types:

- `<unsigned-integer>`: An [`<integer>`](/Web/CSS/integer), whose first character is neither U+002D HYPHEN-MINUS character (-) nor U+002B PLUS SIGN (+); for example `1234`.
