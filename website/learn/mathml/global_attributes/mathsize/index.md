...
The **`mathsize`** [global attribute](/Web/MathML/Global_attributes) sets the [font-size](/Web/CSS/font-size) of a MathML element.
...
> [!NOTE]
> Some browsers may also accept [legacy MathML lengths](/Web/MathML/Values#legacy_mathml_lengths).
