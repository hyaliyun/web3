...
This is an alphabetical list of MathML attributes. More details for each attribute are available on relevant [MathML element pages](/Web/MathML/Element) and on the [global attributes page](/Web/MathML/Global_attributes). The [values](/Web/MathML/Values) page also describes some notes on common values used by MathML attributes.

> [!NOTE]
> As explained on the main [MathML](/Web/MathML) page, MDN uses [MathML Core](https://w3c.github.io/mathml-core/) as a reference specification. However, legacy features that are still implemented by some browsers are also documented. You can find further details for these and other features in [MathML 4](https://w3c.github.io/mathml/).
...
<table class="standard-table">
  ...
  <tbody>
    <tr>
      ...
      <td>
         A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether the operator should be treated as an accent when used as an under- or over-script.
      </td>
    </tr>
    <tr>
      <td><code>accent</code></td>
      ...
      <td>
         A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether the under script should be treated as an accent.
      </td>
    </tr>
    <tr>
      ...
      <td>
         A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether the over script should be treated as an accent.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Use CSS <a href="/Web/CSS/background-color"><code>background-color</code></a> instead.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mstyle") }}</td>
      <td>
        Use CSS <a href="/Web/CSS/color"><code>color</code></a> instead.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>dir</code></td>
      <td>
        <a href="/Web/MathML/Global_attributes">All MathML elements</a>
      </td>
      <td>
    ...
    <tr>
      ...
      <td><a href="/Web/MathML/Global_attributes">All MathML elements</a></td>
      <td>
        <p>
        A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> specifying whether to set the
        <a href="/Web/CSS/math-style">math-style</a>
    ...
    <tr>
      ...
      <td>
        A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> specifying whether the operator is a fence (such as
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mstyle") }}</td>
      <td>
        Use CSS <a href="/Web/CSS/font-family"><code>font-family</code></a> instead.
      </td>
    </tr>
    <tr>
      ...
      <td>{{ MathMLElement("mstyle") }}</td>
      <td>
        Use CSS <a href="/Web/CSS/font-size"><code>font-size</code></a> instead.
      </td>
    </tr>
    <tr>
      ...
      <td>{{ MathMLElement("mstyle") }}</td>
      <td>
        Use CSS <a href="/Web/CSS/font-style"><code>font-style</code></a> instead.
      </td>
    </tr>
    <tr>
      ...
      <td>{{ MathMLElement("mstyle") }}</td>
      <td>
        Use CSS <a href="/Web/CSS/font-weight"><code>font-weight</code></a> instead.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><a href="/Web/MathML/Global_attributes">All MathML elements</a></td>
      <td>
        A <a href="/Web/CSS/background-color">background-color</a> for the element.
      </td>
    </tr>
    <tr>
      ...
      <td><a href="/Web/MathML/Global_attributes">All MathML elements</a></td>
      <td>
        A <a href="/Web/CSS/color">color</a> for the element.
      </td>
    </tr>
    <tr>
      ...
      <td><a href="/Web/MathML/Global_attributes">All MathML elements</a></td>
      <td>
        A {{cssxref("length-percentage")}} used as a <a href="/Web/CSS/font-size"><code>font-size</code></a> for the element.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mo") }}</td>
      <td>
        A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether attached under- and overscripts move to sub- and superscript positions when <a href="/Web/CSS/math-style">math-style</a> is set to <code>compact</code>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><a href="/Web/MathML/Global_attributes">All MathML elements</a></td>
      <td>
        Specifies a <a href="/Web/CSS/math-depth">math-depth</a> for the element. See the <a href="/Web/MathML/Global_attributes/scriptlevel#values">scriptlevel page</a> for accepted values and mapping.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mo") }}</td>
      <td>
      A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> specifying whether
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mo") }}</td>
      <td>
        A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether the operator stretches to the size of the adjacent element.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>{{ MathMLElement("mo") }}</td>
      <td>
        A <a href="/Web/MathML/Values#mathml-specific_types"><code>&lt;boolean&gt;</code></a> indicating whether a stretchy operator should be vertically symmetric around the imaginary math axis (centered fraction line).
      </td>
    </tr>
    <tr>
