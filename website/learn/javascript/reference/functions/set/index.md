...
Static setters and private setters use similar syntaxes, which are described in the [`static`](/Web/JavaScript/Reference/Classes/static) and [private properties](/Web/JavaScript/Reference/Classes/Private_properties) pages.
