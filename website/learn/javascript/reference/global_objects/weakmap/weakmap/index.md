...
- `iterable`
  - : An [`Array`](/Web/JavaScript/Reference/Global_Objects/Array) or other [iterable object](/Web/JavaScript/Reference/Iteration_protocols) that produces a two-element array-like object whose first element is a value that will be used as a `WeakMap` key and whose second element is the value to associate with that key. Each key-value pair will be added to the new `WeakMap`. null is treated as undefined.
...
- [`WeakMap` in the JavaScript guide](/Web/JavaScript/Guide/Keyed_collections#weakmap_object)
