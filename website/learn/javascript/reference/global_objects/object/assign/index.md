...
invoke [getters](/Web/JavaScript/Reference/Functions/get) and [setters](/Web/JavaScript/Reference/Functions/set). Therefore it
...
> [`null`](/Web/JavaScript/Reference/Operators/null) or {{jsxref("undefined")}} sources.
...
For [deep cloning](/Glossary/Deep_copy), we need to use alternatives like [`structuredClone()`](/Web/API/structuredClone), because `Object.assign()`
...
- [Spread in object literals](/Web/JavaScript/Reference/Operators/Spread_syntax#spread_in_object_literals)
