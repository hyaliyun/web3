...
An object is frozen if and only if it is not [extensible](/Web/JavaScript/Reference/Global_Objects/Object/isExtensible), all its properties are non-configurable, and all its data
