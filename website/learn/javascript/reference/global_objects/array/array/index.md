...
> **Note:** `Array()` can be called with or without [`new`](/Web/JavaScript/Reference/Operators/new). Both create a new `Array` instance.
...
- `arrayLength`
  - : If the only argument passed to the `Array` constructor is an integer
    ...
    `undefined` values — see [sparse arrays](/Web/JavaScript/Guide/Indexed_collections#sparse_arrays)).
...
Arrays can be created using the [literal](/Web/JavaScript/Guide/Grammar_and_types#array_literals)
notation:
