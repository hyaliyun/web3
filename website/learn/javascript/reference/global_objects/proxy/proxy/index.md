...
> **Note:** `Proxy()` can only be constructed with [`new`](/Web/JavaScript/Reference/Operators/new). Attempting to call it without `new` throws a {{jsxref("TypeError")}}.
...
[property accessor](/Web/JavaScript/Reference/Operators/Property_accessors).
...
- [Meta programming](/Web/JavaScript/Guide/Meta_programming) guide
- {{jsxref("Reflect")}}
