...
A new string representing `str` stripped of whitespace from its beginning (left side). Whitespace is defined as [white space](/Web/JavaScript/Reference/Lexical_grammar#white_space) characters plus [line terminators](/Web/JavaScript/Reference/Lexical_grammar#line_terminators).
