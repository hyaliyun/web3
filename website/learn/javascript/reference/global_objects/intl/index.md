...
Unlike most global objects, `Intl` is not a constructor. You cannot use it with the [`new` operator](/Web/JavaScript/Reference/Operators/new) or invoke the `Intl` object as a function. All properties and methods of `Intl` are static (just like the {{jsxref("Math")}} object).
...
- A locale: A locale identifier or an [`Intl.Locale`](/Web/JavaScript/Reference/Global_Objects/Intl/Locale) object that wraps a locale identifier.
...
- `Intl[Symbol.toStringTag]`
  - : The initial value of the [`[Symbol.toStringTag]`](/Web/JavaScript/Reference/Global_Objects/Symbol/toStringTag) property is the string `"Intl"`. This property is used in {{jsxref("Object.prototype.toString()")}}.
