...
For a list of supported calendar types, see [`Intl.Locale.prototype.getCalendars()`](/Web/JavaScript/Reference/Global_Objects/Intl/Locale/getCalendars#supported_calendar_types).
...
- {{jsxref("Intl.Locale")}}
- [`Intl.Locale.prototype.getCalendars()`](/Web/JavaScript/Reference/Global_Objects/Intl/Locale/getCalendars)
