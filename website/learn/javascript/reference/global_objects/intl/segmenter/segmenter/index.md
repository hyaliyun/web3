...
> **Note:** `Intl.Segmenter()` can only be constructed with [`new`](/Web/JavaScript/Reference/Operators/new). Attempting to call it without `new` throws a {{jsxref("TypeError")}}.
...
A new [`Intl.Segmenter`](/Web/JavaScript/Reference/Global_Objects/Intl/Segmenter) instance.
