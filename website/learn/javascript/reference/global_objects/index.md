...
Other objects in the global scope are either [created by the user script](/Web/JavaScript/Guide/Working_with_objects#creating_new_objects) or provided by the host application. The host objects available in browser contexts are documented in the [API reference](/Web/API).

For more information about the distinction between the [DOM](/Web/API/Document_Object_Model) and core [JavaScript](/Web/JavaScript), see [JavaScript technologies overview](/Web/JavaScript/JavaScript_technologies_overview).
