...
You can also define async functions using the [`async function` declaration](/Web/JavaScript/Reference/Statements/async_function) or the [arrow syntax](/Web/JavaScript/Reference/Functions/Arrow_functions).
