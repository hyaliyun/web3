...
be converted to a [boolean primitive](/Web/JavaScript/Data_structures#boolean_type).
...
(see [operator precedence](/Web/JavaScript/Reference/Operators/Operator_precedence)).
...
> filter out [`null`](/Web/JavaScript/Reference/Operators/null) or {{jsxref("undefined")}}, consider using
> [the nullish coalescing operator](/Web/JavaScript/Reference/Operators/Nullish_coalescing).
