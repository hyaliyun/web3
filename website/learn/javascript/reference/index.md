...
If you are new to JavaScript, start with the [guide](/Web/JavaScript/Guide). Once you have a firm grasp of the fundamentals, you can use the reference to get more details on individual objects and language constructs.

## Built-ins

[JavaScript standard built-in objects](/Web/JavaScript/Reference/Global_Objects), along with their methods and properties.
...
[JavaScript expressions and operators](/Web/JavaScript/Reference/Operators).

### Primary expressions

- {{jsxref("Operators/this", "this")}}
- [Literals](/Web/JavaScript/Reference/Lexical_grammar#literals)
- {{jsxref("Array", "[]")}}
...
- [`[a, b] = arr`, `{ a, b } = obj`](/Web/JavaScript/Reference/Operators/Destructuring_assignment)
...
[JavaScript functions.](/Web/JavaScript/Reference/Functions)
...
[JavaScript classes.](/Web/JavaScript/Reference/Classes)
...
[JavaScript regular expressions.](/Web/JavaScript/Reference/Regular_expressions)
...
- [Data types and data structures](/Web/JavaScript/Data_structures)
- [Iteration protocols](/Web/JavaScript/Reference/Iteration_protocols)
- [Trailing commas](/Web/JavaScript/Reference/Trailing_commas)
- [Errors](/Web/JavaScript/Reference/Errors)
