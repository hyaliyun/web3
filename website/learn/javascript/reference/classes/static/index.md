...
> [!NOTE]
> In the context of classes, MDN Web Docs content uses the terms properties and [fields](/Web/JavaScript/Reference/Classes/Public_class_fields) interchangeably.
...
- For private static features, see [private properties](/Web/JavaScript/Reference/Classes/Private_properties).
- For instance features, see [methods definitions](/Web/JavaScript/Reference/Functions/Method_definitions), [getter](/Web/JavaScript/Reference/Functions/get), [setter](/Web/JavaScript/Reference/Functions/set), and [public class fields](/Web/JavaScript/Reference/Classes/Public_class_fields).

Public static features are declared using the `static` keyword. They are added to the class constructor at the time of [class evaluation](/Web/JavaScript/Reference/Classes#evaluation_order) using the [`[[DefineOwnProperty]]`](/Web/JavaScript/Reference/Global_Objects/Proxy/Proxy/defineProperty) semantic (which is essentially {{jsxref("Object.defineProperty()")}}). They are accessed again from the class constructor.
...
In the field initializer, [`this`](/Web/JavaScript/Reference/Operators/this) refers to the current class (which you can also access through its name), and [`super`](/Web/JavaScript/Reference/Operators/super) refers to the base class constructor.
...
In order to call a static method or property within another static method of the same class, you can use the [`this`](/Web/JavaScript/Reference/Operators/this) keyword.
