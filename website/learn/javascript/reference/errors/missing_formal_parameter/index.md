...
parameters must be [identifiers](/Glossary/Identifier), not any
...
In [JavaScript](/Glossary/JavaScript), identifiers can contain
...
- [SyntaxError: redeclaration of formal parameter "x"](/Web/JavaScript/Reference/Errors/Redeclared_parameter)
