...
declared, or you need to make sure it is available in your current script or [scope](/Glossary/Scope).
...
inside a [function](/Web/JavaScript/Reference/Functions) cannot be
...
- [Declaring variables in the JavaScript Guide](/Web/JavaScript/Guide/Grammar_and_types#declaring_variables)
- [Function scope in the JavaScript Guide](/Web/JavaScript/Guide/Functions#function_scope)
