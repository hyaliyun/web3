...
The [JavaScript reference](/Web/JavaScript/Reference/Statements)
...
See [Expressions and operators](/Web/JavaScript/Guide/Expressions_and_operators)
...
> **Note:** [`var`](/Web/JavaScript/Reference/Statements/var)-declared variables are not block-scoped, but are scoped to the containing function or script, and the effects of setting them persist beyond the block itself. For example:
>
> ```js
> var x = 1;
> {
...
`true` or `false`. (See [Boolean](/Web/JavaScript/Reference/Global_Objects/Boolean#description)
...
However, in the rare case you find yourself wanting to do something like that, the [`while`](/Web/JavaScript/Reference/Statements/while) documentation has a [Using an assignment as a condition](/Web/JavaScript/Reference/Statements/while#using_an_assignment_as_a_condition) section with guidance on a general best-practice syntax you should know about and follow.

#### Falsy values

The following values evaluate to `false` (also known as [Falsy](/Glossary/Falsy) values):
...
- [ECMAScript exceptions](/Web/JavaScript/Reference/Global_Objects/Error#error_types)
- [`DOMException`](/Web/API/DOMException)
...
For more information, see [nested try-blocks](/Web/JavaScript/Reference/Statements/try...catch#nested_try_blocks)
on the [`try...catch`](/Web/JavaScript/Reference/Statements/try...catch)
reference page.
