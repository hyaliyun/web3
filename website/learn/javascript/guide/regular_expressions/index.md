...
This chapter describes JavaScript regular expressions. It provides a brief overview of each syntax element. For a detailed explanation of each one's semantics, read the [regular expressions](/Web/JavaScript/Reference/Regular_expressions) reference.
...
The match made with this part of the pattern is remembered for later use, as described in [Using groups](/Web/JavaScript/Guide/Regular_expressions/Groups_and_backreferences#using_groups).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>
          <a
            href="/Web/JavaScript/Guide/Regular_expressions/Groups_and_backreferences"
    ...
    <tr>
      ...
      <td>
        <p>
          <a
            href="/Web/JavaScript/Guide/Regular_expressions/Quantifiers"
            >Quantifiers</a
          >
        </p>
      </td>
...
> **Note:** [A larger cheat sheet is also available](/Web/JavaScript/Guide/Regular_expressions/Cheatsheet) (only aggregating parts of those individual articles).
...
Once remembered, the substring can be recalled for other use. See [Groups and backreferences](/Web/JavaScript/Guide/Regular_expressions/Groups_and_backreferences#using_groups) for more details.
...
The `u` flag is used to create "unicode" regular expressions; that is, regular expressions which support matching against unicode text. An important feature that's enabled in unicode mode is [Unicode property escapes](/Web/JavaScript/Reference/Regular_expressions/Unicode_character_class_escape). For example, the following regular expression might be used to match against an arbitrary unicode "word":

```js
/\p{L}*/u;
```

Unicode regular expressions have different execution behavior as well. [`RegExp.prototype.unicode`](/Web/JavaScript/Reference/Global_Objects/RegExp/unicode) contains more explanation about this.
...
> - The guide articles: [character classes](/Web/JavaScript/Guide/Regular_expressions/Character_classes), [assertions](/Web/JavaScript/Guide/Regular_expressions/Assertions), [groups and backreferences](/Web/JavaScript/Guide/Regular_expressions/Groups_and_backreferences), [quantifiers](/Web/JavaScript/Guide/Regular_expressions/Quantifiers)
