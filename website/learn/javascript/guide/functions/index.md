...
See also the [exhaustive reference chapter about JavaScript functions](/Web/JavaScript/Reference/Functions) to get to know the details.

## Defining functions

### Function declarations

A **function definition** (also called a **function declaration**, or **function statement**) consists of the [`function`](/Web/JavaScript/Reference/Statements/function) keyword, followed by:
...
While the function declaration above is syntactically a statement, functions can also be created by a [function expression](/Web/JavaScript/Reference/Operators/function).
...
A **method** is a function that is a property of an object. Read more about objects and methods in [Working with objects](/Web/JavaScript/Guide/Working_with_objects).
...
The arguments of a function are not limited to strings and numbers. You can pass whole objects to a function. The `showProps()` function (defined in [Working with objects](/Web/JavaScript/Guide/Working_with_objects#objects_and_properties)) is an example of a function that takes an object as an argument.
...
It turns out that _functions are themselves objects_ — and in turn, these objects have methods. (See the {{jsxref("Function")}} object.) The [`call()`](/Web/JavaScript/Reference/Global_Objects/Function/call) and [`apply()`](/Web/JavaScript/Reference/Global_Objects/Function/apply) methods can be used to achieve this goal.
...
2. [`arguments.callee`](/Web/JavaScript/Reference/Functions/arguments/callee)
...
However, some algorithms cannot be simple iterative loops. For example, getting all the nodes of a tree structure (such as the [DOM](/Web/API/Document_Object_Model)) is easier via recursion:
...
For more details, see [default parameters](/Web/JavaScript/Reference/Functions/Default_parameters) in the reference.

### Rest parameters

The [rest parameter](/Web/JavaScript/Reference/Functions/rest_parameters) syntax allows us to represent an indefinite number of arguments as an array.
...
An [arrow function expression](/Web/JavaScript/Reference/Functions/Arrow_functions) (also called a _fat arrow_ to distinguish from a hypothetical `->` syntax in future JavaScript) has a shorter syntax compared to function expressions and does not have its own [`this`](/Web/JavaScript/Reference/Operators/this), [`arguments`](/Web/JavaScript/Reference/Functions/arguments), [`super`](/Web/JavaScript/Reference/Operators/super), or [`new.target`](/Web/JavaScript/Reference/Operators/new.target). Arrow functions are always anonymous.
...
Until arrow functions, every new function defined its own [`this`](/Web/JavaScript/Reference/Operators/this) value (a new object in the case of a constructor, undefined in [strict mode](/Web/JavaScript/Reference/Strict_mode) function calls, the base object if the function is called as an "object method", etc.). This proved to be less than ideal with an object-oriented style of programming.
...
Alternatively, a [bound function](/Web/JavaScript/Reference/Global_Objects/Function/bind) could be created so that the proper `this` value would be passed to the `growUp()` function.
