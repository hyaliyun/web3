...
The **`font-variation-settings`** [CSS](/Web/CSS) property provides low-level control over [variable font](/Web/CSS/CSS_fonts/Variable_fonts_guide) characteristics by letting you specify the four letter axis names of the characteristics you want to vary along with their values.
...
You can find a number of other variable font examples in our [Variable fonts guide](/Web/CSS/CSS_fonts/Variable_fonts_guide).
