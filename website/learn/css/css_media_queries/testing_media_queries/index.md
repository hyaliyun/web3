...
For example, to set up a query list that determines if the device is in landscape or portrait [orientation](/Web/CSS/@media/orientation):
...
Once you've created your media query list, you can check the result of the query by looking at the value of its [`matches`](/Web/API/MediaQueryList/matches) property:
