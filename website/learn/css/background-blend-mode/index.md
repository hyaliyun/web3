...
The **`background-blend-mode`** [CSS](/Web/CSS) property sets how an element's background images should blend with each other and with the element's background color.
