...
The **`grid-auto-flow`** [CSS](/Web/CSS) property controls how the auto-placement algorithm works, specifying exactly how auto-placed items get flowed into the grid.

{{EmbedInteractiveExample("pages/css/grid-auto-flow.html")}}

> [!NOTE]
> The `masonry-auto-flow` property was dropped from CSS [Masonry layout](/Web/CSS/CSS_grid_layout/Masonry_layout) in favor of `grid-auto-flow`.
