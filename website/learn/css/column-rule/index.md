...
The **`column-rule`** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property sets the width, style, and color of the line drawn between columns in a multi-column layout.
