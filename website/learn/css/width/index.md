...
The **`width`** [CSS](/Web/CSS) property sets an element's width. By default, it sets the width of the [content area](/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#content_area), but if {{cssxref("box-sizing")}} is set to `border-box`, it sets the width of the [border area](/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#border_area).
...
- {{cssxref("&lt;percentage&gt;")}}
  - : Defines the width as a percentage of the [containing block](/Web/CSS/Containing_block)'s width.
- `auto`
