...
The **`max-width`** [CSS](/Web/CSS) property sets the maximum width of an element. It prevents the [used value](/Web/CSS/used_value) of the {{cssxref("width")}} property from becoming larger than the value specified by `max-width`.
