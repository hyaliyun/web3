...
The **`border-block-end`** [CSS](/Web/CSS) property is a [shorthand property](/Web/CSS/Shorthand_properties) for setting the individual logical block-end border property values in a single place in the style sheet.
...
- [`border-block-end-color`](/Web/CSS/border-block-end-color)
- [`border-block-end-style`](/Web/CSS/border-block-end-style)
- [`border-block-end-width`](/Web/CSS/border-block-end-width)
