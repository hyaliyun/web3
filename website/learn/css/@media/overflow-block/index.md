...
The **`overflow-block`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) can be used to test how the output device handles content that overflows the initial [containing block](/Web/CSS/Containing_block) along the block axis.
