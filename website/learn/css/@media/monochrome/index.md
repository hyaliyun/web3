...
The **`monochrome`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) can be used to test the number of bits per pixel in the monochrome frame buffer of the output device.
