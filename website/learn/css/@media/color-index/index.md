...
The **`color-index`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) can be used to test the number of entries in the output device's color lookup table.
