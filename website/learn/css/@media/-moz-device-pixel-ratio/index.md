...
The **`-moz-device-pixel-ratio`** Gecko-only [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) can be used to apply styles based on the number of device pixels per CSS pixel.

> [!WARNING]
> Do not use this feature. Use the [`resolution`](/Web/CSS/@media/resolution) feature with the `dppx` unit instead.
