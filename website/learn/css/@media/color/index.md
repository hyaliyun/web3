...
The **`color`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) can be used to test the number of bits per color component (red, green, blue) of the output device.
...
See [Applying color to HTML elements using CSS](/Web/CSS/CSS_colors/Applying_color) to learn more about using CSS to apply color to HTML.
