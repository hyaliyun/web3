...
The **`prefers-reduced-data`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) is used to detect if the user has requested the web content that consumes less internet traffic.
