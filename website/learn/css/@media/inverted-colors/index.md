...
The **`inverted-colors`** [CSS](/Web/CSS) [media feature](/Web/CSS/@media#media_features) is used to test if the {{glossary("user agent")}} or the underlying operating system has inverted all colors.
