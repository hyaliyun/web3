...
- [`<easing-function>`](/Web/CSS/easing-function) data type
- [`prefers-reduced-motion`](/Web/CSS/@media/prefers-reduced-motion) media query
...
- Properties in the [transitions](/Web/CSS/CSS_transitions) CSS module to trigger animations based on user actions
- The {{htmlelement("canvas")}} HTML element along with [canvas API](/Web/API/Canvas_API) and [WebGL API](/Web/API/WebGL_API) to draw graphics and animations
