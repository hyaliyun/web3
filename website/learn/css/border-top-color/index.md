...
The **`border-top-color`** [CSS](/Web/CSS) property sets the color of an element's top [border](/Web/CSS/border). It can also be set with the shorthand CSS properties {{cssxref("border-color")}} or {{cssxref("border-top")}}.
