...
The **`touch-action`** [CSS](/Web/CSS) property sets how an element's region can be manipulated by a touchscreen user (for example, by zooming features built into the browser).
...
- [Pointer Events](/Web/API/Pointer_events)
...
- [Scroll Snap](/Web/CSS/CSS_scroll_snap)
