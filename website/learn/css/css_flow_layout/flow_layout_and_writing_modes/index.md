...
The [CSS logical properties and values](/Web/CSS/CSS_logical_properties_and_values) module includes logical versions of the properties that control margins, padding and borders as well as other mappings for things that we have typically used physical directions to specify.
...
- [Writing Modes](/Web/CSS/CSS_writing_modes)
