...
You can read more about margin collapsing in our article [Mastering Margin Collapsing](/Web/CSS/CSS_box_model/Mastering_margin_collapsing).
...
Find out more about how Block and Inline Boxes behave in our Guide to the [Visual Formatting Model](/Web/CSS/Visual_formatting_model).
...
- [CSS Basic Box Model](/Web/CSS/CSS_box_model)
- _[Normal Flow](/Learn/CSS/CSS_layout/Normal_Flow)_ - Learn Layout
- [Inline-level elements](/Glossary/Inline-level_content)
- [Block-level elements](/Glossary/Block-level_content)
