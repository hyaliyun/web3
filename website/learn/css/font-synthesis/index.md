...
The **`font-synthesis`** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property lets you specify whether or not the browser may synthesize the bold, italic, small-caps, and/or subscript and superscript typefaces when they are missing in the specified font-family.
...
- [font-synthesis-weight](/Web/CSS/font-synthesis-weight)
- [font-synthesis-style](/Web/CSS/font-synthesis-style)
- [font-synthesis-small-caps](/Web/CSS/font-synthesis-small-caps)
- [font-synthesis-position](/Web/CSS/font-synthesis-position)
...
For example, using the [:lang()](/Web/CSS/:lang) pseudo-class, you can disable the browser from synthesizing bold and oblique characters for a language, in this case Arabic:
...
| font-synthesis value               | [font-synthesis-weight](/Web/CSS/font-synthesis-weight) value | [font-synthesis-style](/Web/CSS/font-synthesis-style) value | [font-synthesis-small-caps](/Web/CSS/font-synthesis-small-caps) value | [font-synthesis-position](/Web/CSS/font-synthesis-position) value |
| :--------------------------------- | :----------------------------------------------------------------------- | :--------------------------------------------------------------------- | :------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- |
