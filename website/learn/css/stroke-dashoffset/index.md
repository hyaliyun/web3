...
The **`stroke-dashoffset`** [CSS](/Web/CSS) property defines an offset for the starting point of the rendering of an [SVG](/Web/SVG) element's associated [dash array](/Web/CSS/stroke-dasharray). If present, it overrides the element's {{SVGAttr("stroke-dashoffset")}} attribute.
