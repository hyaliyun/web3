...
The `scroll-padding-inline` [shorthand property](/Web/CSS/Shorthand_properties) sets the scroll padding of an element in the inline dimension.
...
- [`scroll-padding-inline-end`](/Web/CSS/scroll-padding-inline-end)
- [`scroll-padding-inline-start`](/Web/CSS/scroll-padding-inline-start)
