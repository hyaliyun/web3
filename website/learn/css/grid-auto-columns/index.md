...
The **`grid-auto-columns`** [CSS](/Web/CSS) property specifies the size of an implicitly-created grid column {{glossary("grid tracks", "track")}} or pattern of tracks.
...
- {{cssxref("grid")}}
- [Auto-placement in grid layout: sizing rows in the implicit grid](/Web/CSS/CSS_grid_layout/Auto-placement_in_grid_layout#sizing_rows_in_the_implicit_grid)
