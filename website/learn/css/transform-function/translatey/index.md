...
The **`translateY()`** [CSS](/Web/CSS) [function](/Web/CSS/CSS_Functions) repositions an element vertically on the 2D plane. Its result
...
- `<length-percentage>`
  - : The value is a {{cssxref("&lt;length&gt;")}} or {{cssxref("&lt;percentage&gt;")}} representing the ordinate (vertical, y-coordinate) of the
    translating vector [0, ty]. In [Cartesian coordinate system](/Web/CSS/transform-function#cartesian_coordinates) it represents shift along y-axis. A percentage value refers to the height of the reference box defined by the
