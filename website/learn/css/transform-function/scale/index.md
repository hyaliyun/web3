...
The **`scale()`** [CSS](/Web/CSS) [function](/Web/CSS/CSS_Functions) defines a transformation that resizes an element on the 2D
...
> [`scale3d()`](/Web/CSS/transform-function/scale3d) instead.
...
— use it to write a [media query](/Web/CSS/CSS_media_queries) that will turn off animations if the
user has reduced animation specified in their system preferences.

Find out more:

- [MDN Understanding WCAG, Guideline 2.3 explanations](/Web/Accessibility/Understanding_WCAG/Operable#guideline_2.3_%e2%80%94_seizures_and_physical_reactions_do_not_design_content_in_a_way_that_is_known_to_cause_seizures_or_physical_reactions)
