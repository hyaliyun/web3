...
The **`<transform-function>`** [CSS](/Web/CSS) [data type](/Web/CSS/CSS_Types) represents a transformation that affects an element's appearance. Transformation [functions](/Web/CSS/CSS_Functions) can rotate, resize, distort, or move an element in 2D or 3D space. It is used in the {{cssxref("transform")}} property.
...
- [`matrix()`](/Web/CSS/transform-function/matrix)
  - : Describes a homogeneous 2D transformation matrix.
- [`matrix3d()`](/Web/CSS/transform-function/matrix3d)
  - : Describes a 3D transformation as a 4×4 homogeneous matrix.

### Perspective

- [`perspective()`](/Web/CSS/transform-function/perspective)
  - : Sets the distance between the user and the z=0 plane.

### Rotation

- [`rotate()`](/Web/CSS/transform-function/rotate)
  - : Rotates an element around a fixed point on the 2D plane.
- [`rotate3d()`](/Web/CSS/transform-function/rotate3d)
  - : Rotates an element around a fixed axis in 3D space.
- [`rotateX()`](/Web/CSS/transform-function/rotateX)
  - : Rotates an element around the horizontal axis.
- [`rotateY()`](/Web/CSS/transform-function/rotateY)
  - : Rotates an element around the vertical axis.
- [`rotateZ()`](/Web/CSS/transform-function/rotateZ)
  - : Rotates an element around the z-axis.

### Scaling (resizing)

- [`scale()`](/Web/CSS/transform-function/scale)
  - : Scales an element up or down on the 2D plane.
- [`scale3d()`](/Web/CSS/transform-function/scale3d)
  - : Scales an element up or down in 3D space.
- [`scaleX()`](/Web/CSS/transform-function/scaleX)
  - : Scales an element up or down horizontally.
- [`scaleY()`](/Web/CSS/transform-function/scaleY)
...
- [`skew()`](/Web/CSS/transform-function/skew)
  - : Skews an element on the 2D plane.
- [`skewX()`](/Web/CSS/transform-function/skewX)
  - : Skews an element in the horizontal direction.
- [`skewY()`](/Web/CSS/transform-function/skewY)
  - : Skews an element in the vertical direction.

### Translation (moving)

- [`translate()`](/Web/CSS/transform-function/translate)
  - : Translates an element on the 2D plane.
- [`translate3d()`](/Web/CSS/transform-function/translate3d)
  - : Translates an element in 3D space.
- [`translateX()`](/Web/CSS/transform-function/translateX)
  - : Translates an element horizontally.
- [`translateY()`](/Web/CSS/transform-function/translateY)
  - : Translates an element vertically.
- [`translateZ()`](/Web/CSS/transform-function/translateZ)
