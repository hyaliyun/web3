...
The **`transition-property`** [CSS](/Web/CSS) property sets the CSS properties to which a [transition effect](/Web/CSS/CSS_transitions/Using_CSS_transitions) should be applied.
...
When the button is hovered or focused, it undergoes a one-second color transition; the `transition-property` is [`background-color`](/Web/CSS/background-color).
...
See our [Using CSS transitions](/Web/CSS/CSS_transitions/Using_CSS_transitions) guide for more `transition-property` examples.
