...
The **`animation-delay`** [CSS](/Web/CSS) property specifies the amount of time to wait from applying the animation to an element before beginning to perform the animation. The animation can start later, immediately from its beginning, or immediately and partway through the animation.
...
> **Note:** `animation-delay` has no effect on [CSS scroll-driven animations](/Web/CSS/CSS_scroll-driven_animations).
