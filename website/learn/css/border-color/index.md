...
The **`border-color`** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property sets the color of an element's border.
...
You can find out more information about border colors in [Applying colors to HTML elements](/Web/CSS/CSS_colors/Applying_color#borders).

## Constituent properties

This property is a shorthand for the following CSS properties:

- [`border-bottom-color`](/Web/CSS/border-bottom-color)
- [`border-left-color`](/Web/CSS/border-left-color)
- [`border-right-color`](/Web/CSS/border-right-color)
