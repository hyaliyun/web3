...
The **`@document`** [CSS](/Web/CSS) [at-rule](/Web/CSS/At-rule) restricts the style rules contained within it based on the URL of the document. It is designed primarily for user-defined style sheets, though it can be used on author-defined style sheets, too.
...
- `regexp()`
  - : Matches if the document URL is matched by the [regular expression](/Web/JavaScript/Guide/Regular_expressions) provided. The expression must match the entire URL.
