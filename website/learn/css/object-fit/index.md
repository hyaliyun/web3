...
The **`object-fit`** [CSS](/Web/CSS) property sets how the content of a [replaced element](/Web/CSS/Replaced_element), such as an {{HTMLElement("img")}} or {{HTMLElement("video")}}, should be resized to fit its container.
