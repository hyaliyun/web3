...
The [CSS Shapes module](/Web/CSS/CSS_shapes) describes geometric shapes in CSS. This article provides an overview of how you can use shapes to wrap text around floated elements that are not necessarily rectangular.
...
In our [Guide to Basic Shapes](/Web/CSS/CSS_shapes/Basic_shapes) we explore each of the possible Basic Shapes and how to create them.
...
To explore the box values in more detail, see our guide covering [Shapes from box values](/Web/CSS/CSS_shapes/From_box_values).
...
Note that images used in this way must be [CORS compatible](/Web/HTTP/CORS), otherwise `shape-outside` will act as if `none` had been given as the value, and you will get no shape.
...
To learn more about creating shapes from images, see the [Shapes from images](/Web/CSS/CSS_shapes/Shapes_from_images) guide.
...
In this guide, we discussed wrapping text around floated shapes. See the [CSS shapes module](/Web/CSS/CSS_shapes) for links to all the module features plus additional related features. This includes all the shape functions and relevant guides.
