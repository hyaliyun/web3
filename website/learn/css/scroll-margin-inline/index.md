...
The `scroll-margin-inline` [shorthand property](/Web/CSS/Shorthand_properties) sets the scroll margins of an element in the inline dimension.
...
- [`scroll-margin-inline-end`](/Web/CSS/scroll-margin-inline-end)
- [`scroll-margin-inline-start`](/Web/CSS/scroll-margin-inline-start)
