...
The **`<resolution>`** [CSS](/Web/CSS) [data type](/Web/CSS/CSS_Types), used for describing [resolutions](/Web/CSS/@media/resolution) in [media queries](/Web/CSS/CSS_media_queries), denotes the pixel density of an output device, i.e., its resolution.
...
- `dppx`
  - : Represents the number of dots per [`px`](/Web/CSS/length#px) unit. Due to the 1:96 fixed ratio of CSS `in` to CSS `px`, `1dppx` is equivalent to `96dpi`, which corresponds to the default resolution of images displayed in CSS as defined by {{cssxref("image-resolution")}}.
- `x`
  - : Alias for `dppx`.
...
- [resolution](/Web/CSS/@media/resolution) media feature
