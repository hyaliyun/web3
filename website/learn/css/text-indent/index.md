...
The **`text-indent`** [CSS](/Web/CSS) property sets the length of empty space (indentation) that is put before lines of text in a block.
...
Treating first paragraphs differently from subsequent paragraphs can be done using the [next-sibling combinator](/Web/CSS/Next-sibling_combinator), as in the following example:
...
- Related CSS properties:
  ...
  - [`text-justify`](/Web/CSS/text-justify)
  - [`text-orientation`](/Web/CSS/text-orientation)
  - [`text-overflow`](/Web/CSS/text-overflow)
  - [`text-rendering`](/Web/CSS/text-rendering)
