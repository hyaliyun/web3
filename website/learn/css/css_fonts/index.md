...
- [`<feature-tag-value>`](/Web/CSS/font-feature-settings#values)
...
- [`<font-stretch-css3>`](/Web/CSS/font-stretch#values)

`font-tech` types:

- [`<color-font-tech>`](/Web/CSS/@supports#font-tech)
- [`<font-features-tech>`](/Web/CSS/@supports#font-tech)
- [`<font-tech>`](/Web/CSS/@supports#font-tech)

`font-variant` types:

- [`<font-variant-css2>`](/Web/CSS/font-variant)
- [`<east-asian-variant-values>`](/Web/CSS/font-variant#values)
- [`<east-asian-width-values>`](/Web/CSS/font-variant#values)

`font-variant-ligatures` types:

- [`<common-lig-values>`](/Web/CSS/font-variant-ligatures#values)
- [`<contextual-alt-values>`](/Web/CSS/font-variant-ligatures#values)
- [`<discretionary-lig-values>`](/Web/CSS/font-variant-ligatures#values)
- [`<historical-lig-values>`](/Web/CSS/font-variant-ligatures#values)

`font-variant-numeric` types:

- [`<numeric-figure-values>`](/Web/CSS/font-variant-numeric#values)
- [`<numeric-fraction-values>`](/Web/CSS/font-variant-numeric#values)
- [`<numeric-spacing-values>`](/Web/CSS/font-variant-numeric#values)

`font-weight` type:

- [`<font-weight-absolute>`](/Web/CSS/font-weight#values)
...
- [Learn: Fundamental text and font styling](/Learn/CSS/Styling_text/Fundamentals)
...
- [Learn: Web fonts](/Learn/CSS/Styling_text/Web_fonts)
...
- [OpenType font features guide](/Web/CSS/CSS_fonts/OpenType_fonts_guide)
...
- [Improving font performance](/Learn/Performance/CSS#improving_font_performance)
...
- [CSS font loading](/Web/CSS/CSS_font_loading) module
- [CSS font loading API](/Web/API/CSS_Font_Loading_API)
- [CSS text](/Web/CSS/CSS_text) module
- [CSS writing modes](/Web/CSS/CSS_writing_modes) module
