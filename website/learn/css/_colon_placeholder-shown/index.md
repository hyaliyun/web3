...
The **`:placeholder-shown`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) represents any  or {{HTMLElement("textarea")}} element that is currently displaying [placeholder text](/Web/HTML/Element/input#placeholder).
