...
The **`transition-timing-function`** [CSS](/Web/CSS) property sets how intermediate values are calculated for CSS properties being affected by a [transition effect](/Web/CSS/CSS_transitions/Using_CSS_transitions).
...
Consider providing a mechanism for pausing or disabling animation, as well as using the [Reduced Motion Media Query](/Web/CSS/@media/prefers-reduced-motion) (or equivalent [User Agent client hint](/Web/HTTP/Client_hints#user-agent_client_hints) {{HTTPHeader("Sec-CH-Prefers-Reduced-Motion")}}) to create a complimentary experience for users who have expressed a preference for less animation.
...
- [`<easing-function>`](/Web/CSS/easing-function)
- {{cssxref('transition')}}
