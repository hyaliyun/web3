...
The **`minmax()`** [CSS function](/Web/CSS/CSS_Functions) defines a size range greater than or equal to _min_ and less than or equal to _max_. It is used with [CSS grids](/Web/CSS/CSS_grid_layout).
...
- [Basic concepts of grid layout: track sizing with minmax()](/Web/CSS/CSS_grid_layout/Basic_concepts_of_grid_layout#track_sizing_and_minmax)
- [CSS grids, logical values and writing modes](/Web/CSS/CSS_grid_layout/Grids_logical_values_and_writing_modes)
