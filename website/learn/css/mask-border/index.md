...
The **`mask-border`** [CSS](/Web/CSS) [shorthand property](/Web/CSS/Shorthand_properties) lets you create a mask along the edge of an element's border.

## Constituent properties

This property is a shorthand for the following CSS properties:

- [`mask-border-mode`](/Web/CSS/mask-border-mode)
- [`mask-border-outset`](/Web/CSS/mask-border-outset)
- [`mask-border-repeat`](/Web/CSS/mask-border-repeat)
- [`mask-border-slice`](/Web/CSS/mask-border-slice)
- [`mask-border-source`](/Web/CSS/mask-border-source)
- [`mask-border-width`](/Web/CSS/mask-border-width)
