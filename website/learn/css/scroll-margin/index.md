...
The **`scroll-margin`** [shorthand property](/Web/CSS/Shorthand_properties) sets all of the scroll margins of an element at once, assigning values much like the [`margin`](/Web/CSS/margin) property does for margins of an element.
...
- [`scroll-margin-bottom`](/Web/CSS/scroll-margin-bottom)
- [`scroll-margin-left`](/Web/CSS/scroll-margin-left)
- [`scroll-margin-right`](/Web/CSS/scroll-margin-right)
- [`scroll-margin-top`](/Web/CSS/scroll-margin-top)
