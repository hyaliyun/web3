...
The [CSS logical properties and values](/Web/CSS/CSS_logical_properties_and_values) module contains logical mappings for the physical values of {{cssxref("float")}} and {{cssxref("clear")}}, and also for the positioning properties used with [positioned layout](/Web/CSS/CSS_positioned_layout). This guide takes a look at how to use these.
