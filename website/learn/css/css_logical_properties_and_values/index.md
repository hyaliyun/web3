...
Logical properties and values use the abstract terms _block_ and _inline_ to describe the direction in which they flow. The physical meaning of these terms depends on the [writing mode](/Web/CSS/CSS_writing_modes).
...
- [Logical properties for sizing](/Web/CSS/CSS_logical_properties_and_values/Sizing)

  - : Flow-relative mappings between physical properties and logical properties used for sizing elements on the page.

- [Logical properties for margins, borders, and padding](/Web/CSS/CSS_logical_properties_and_values/Margins_borders_padding)

  - : Flow-relative mappings for the various margin, border, and padding properties and their shorthands.

- [Logical properties for floating and positioning](/Web/CSS/CSS_logical_properties_and_values/Floating_and_positioning)

  - : Details mappings between the physical and logical values for `float` and `clear`, [inset properties](/Glossary/Inset_properties), and `resize`.
...
[CSS box model](/Web/CSS/CSS_box_model)

- {{CSSxRef("margin")}} shorthand
- {{CSSxRef("padding")}} shorthand

[CSS box sizing](/Web/CSS/CSS_box_sizing)
...
[CSS backgrounds and borders](/Web/CSS/CSS_backgrounds_and_borders)
...
[CSS positioned layout](/Web/CSS/CSS_positioned_layout)
...
[CSS writing modes](/Web/CSS/CSS_writing_modes)
...
[CSS overscroll behavior](/Web/CSS/CSS_overscroll_behavior)
