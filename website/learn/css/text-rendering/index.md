...
The **`text-rendering`** [CSS](/Web/CSS) property provides information to the rendering engine about what to optimize for when rendering text.
...
- [Drawing text in a `<canvas>`](/Web/API/Canvas_API/Tutorial/Drawing_text)
- [CSS Text Decoration](/Web/CSS/CSS_text_decoration) CSS module
- Related CSS properties

  - [`text-decoration`](/Web/CSS/text-decoration) (and its longhand properties, such as [`text-decoration-line`](/Web/CSS/text-decoration-line), [`text-decoration-style`](/Web/CSS/text-decoration-style), and [`text-decoration-thickness`](/Web/CSS/text-decoration-thickness))
  - [`text-emphasis`](/Web/CSS/text-emphasis) (and its longhand properties, including [`text-emphasis-color`](/Web/CSS/text-emphasis-color), [`text-emphasis-position`](/Web/CSS/text-emphasis-position), and [`text-emphasis-style`](/Web/CSS/text-emphasis-style))
  - [`text-shadow`](/Web/CSS/text-shadow)
  - [`text-transform`](/Web/CSS/text-transform)

- The [SVG](/Web/SVG) {{SVGAttr("text-rendering")}} attribute
