...
The **`<blend-mode>`** [CSS](/Web/CSS) [data type](/Web/CSS/CSS_Types) describes how colors should appear when elements overlap. It is used in the {{cssxref("background-blend-mode")}} and {{cssxref("mix-blend-mode")}} properties.
...
- The [CSS compositing and blending](/Web/CSS/CSS_compositing_and_blending) module that defines the `<blend-mode>` values.
