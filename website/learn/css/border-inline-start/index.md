...
The **`border-inline-start`** [CSS](/Web/CSS) property is a [shorthand property](/Web/CSS/Shorthand_properties) for setting the individual logical inline-start border property values in a single place in the style sheet.
...
- [`border-inline-start-color`](/Web/CSS/border-inline-start-color)
- [`border-inline-start-style`](/Web/CSS/border-inline-start-style)
- [`border-inline-start-width`](/Web/CSS/border-inline-start-width)
