...
The **`:last-of-type`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) represents the last element of its type among a group of sibling elements.
...
This example shows how nested elements can also be targeted. Note that the [universal selector](/Web/CSS/Universal_selectors) (`*`) is implied when no simple selector is written.
