...
The **`object-position`** [CSS](/Web/CSS) property specifies the alignment of the selected [replaced element](/Web/CSS/Replaced_element)'s contents within the element's box. Areas of the box which aren't covered by the replaced element's object will show the element's background.
