...
The **`columns`** [CSS](/Web/CSS) shorthand property sets the number of columns to use when drawing an element's contents, as well as those columns' widths.
...
- [`column-count`](/Web/CSS/column-count)
- [`column-width`](/Web/CSS/column-width)
