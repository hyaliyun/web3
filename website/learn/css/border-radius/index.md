...
The **`border-radius`** [CSS](/Web/CSS) property rounds the corners of an element's outer border edge. You can set a single radius to make circular corners, or two radii to make elliptical corners.
...
- [`border-top-left-radius`](/Web/CSS/border-top-left-radius)
- [`border-top-right-radius`](/Web/CSS/border-top-right-radius)
- [`border-bottom-right-radius`](/Web/CSS/border-bottom-right-radius)
- [`border-bottom-left-radius`](/Web/CSS/border-bottom-left-radius)
