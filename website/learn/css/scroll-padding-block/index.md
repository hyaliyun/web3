...
The `scroll-padding-block` [shorthand property](/Web/CSS/Shorthand_properties) sets the scroll padding of an element in the block dimension.
...
- [`scroll-padding-block-end`](/Web/CSS/scroll-padding-block-end)
- [`scroll-padding-block-start`](/Web/CSS/scroll-padding-block-start)
