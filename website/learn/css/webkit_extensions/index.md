...
User agents based on WebKit or Blink, such as Safari and Chrome, support several special extensions to [CSS](/Web/CSS). These extensions are prefixed with `-webkit-`.
...
- `-webkit-box-align`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("align-items")}} property instead.
- `-webkit-box-direction`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("flex-direction")}} property instead.
- {{CSSxRef("box-flex-group", "-webkit-box-flex-group")}}
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{cssxref("flex-basis")}}, {{cssxref("flex-grow")}}, and {{cssxref("flex-shrink")}} properties instead.
- `-webkit-box-flex`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("flex-grow")}} property instead.
- `-webkit-box-lines`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("flex-flow")}} property instead.
- `-webkit-box-ordinal-group`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("order")}} property instead.
- `-webkit-box-orient`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("flex-direction")}} property instead.
- `-webkit-box-pack`
  - : Use the [CSS flexible box layout](/Web/CSS/CSS_flexible_box_layout) with the standard {{CSSxRef("justify-content")}} property instead.

### C-I

- `-webkit-column-break-after`
  - : Use the [CSS multicolumn layout](/Web/CSS/CSS_multicol_layout) with the standard {{cssxref("break-after")}} property instead.
- `-webkit-column-break-before`
  - : Use the [CSS multicolumn layout](/Web/CSS/CSS_multicol_layout) with the standard {{cssxref("break-before")}} property instead.
- `-webkit-column-break-inside`
  - : Use the [CSS multicolumn layout](/Web/CSS/CSS_multicol_layout) with the standard {{cssxref("break-inside")}} property instead.
- `-webkit-font-feature-settings`
  - : Use the [`font-feature-settings`](/Web/CSS/font-feature-settings) property instead.
...
- [Vendor Prefix](/Glossary/Vendor_Prefix) glossary entry
- [Mozilla vendor-prefixed CSS extensions](/Web/CSS/Mozilla_Extensions)
