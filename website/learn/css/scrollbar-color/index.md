...
The **`scrollbar-color`** [CSS](/Web/CSS) property sets the color of the scrollbar track and thumb.
...
> **Note:** [`@media (forced-colors: active)`](/Web/CSS/@media/forced-colors) sets `scrollbar-color` to `auto`.
