...
The **`padding-right`** [CSS](/Web/CSS) property sets the width of the [padding area](/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#padding_area) on the right of an element.
