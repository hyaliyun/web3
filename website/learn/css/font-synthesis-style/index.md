...
The **`font-synthesis-style`** [CSS](/Web/CSS) property lets you specify whether or not the browser may synthesize the oblique typeface when it is missing in a font family.
...
- [font-synthesis](/Web/CSS/font-synthesis) shorthand, [font-synthesis-small-caps](/Web/CSS/font-synthesis-small-caps), [font-synthesis-weight](/Web/CSS/font-synthesis-weight)
