...
The **`animation-composition`** [CSS](/Web/CSS) property specifies the {{Glossary("composite operation")}} to use when multiple animations affect the same property simultaneously.
...
- [Composite property of KeyFrameEffect](/Web/API/KeyframeEffect/composite)
