...
The **`@layer`** [CSS](/Web/CSS) [at-rule](/Web/CSS/At-rule) is used to declare a cascade layer and can also be used to define the order of precedence in case of multiple cascade layers.
...
The declaration order matters. The first declared layer gets the lowest priority and the last declared layer gets the highest priority. However, the priority is reversed when the [`!important`](/Web/CSS/important) flag is used.
...
- [`@import`](/Web/CSS/@import)
- {{domxref("CSSLayerBlockRule")}}
- {{domxref("CSSLayerStatementRule")}}
- [`!important`](/Web/CSS/important)
- [`revert-layer`](/Web/CSS/revert-layer)
- [Introducing the CSS cascade](/Web/CSS/Cascade)
- [Cascade, specificity, and inheritance](/Learn/CSS/Building_blocks/Cascade_and_inheritance)
- [Cascade layers](/Learn/CSS/Building_blocks/Cascade_layers)
