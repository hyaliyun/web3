...
The **`border-block-start`** [CSS](/Web/CSS) property is a [shorthand property](/Web/CSS/Shorthand_properties) for setting the individual logical block-start border property values in a single place in the style sheet.
...
- [`border-block-start-color`](/Web/CSS/border-block-start-color)
- [`border-block-start-style`](/Web/CSS/border-block-start-style)
- [`border-block-start-width`](/Web/CSS/border-block-start-width)
