...
The **`transition-delay`** [CSS](/Web/CSS) property specifies the duration to wait before starting a property's [transition effect](/Web/CSS/CSS_transitions/Using_CSS_transitions) when its value changes.
