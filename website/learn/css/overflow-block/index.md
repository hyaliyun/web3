...
The **`overflow-block`** [CSS](/Web/CSS) property sets what shows when content overflows the block start and block end edges of a box. This may be nothing, a scroll bar, or the overflow content.
...
- [CSS scrollbars style](/Web/CSS/CSS_scrollbars_styling) module
