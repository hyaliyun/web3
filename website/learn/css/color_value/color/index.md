...
Support for a particular color space can be detected with the [`color-gamut`](/Web/CSS/@media/color-gamut) CSS media feature.
...
This example shows how to use the [`color-gamut`](/Web/CSS/@media/color-gamut) media query to detect support for a particular color space and use that color space to specify a color.
...
- [`color-gamut`](/Web/CSS/@media/color-gamut) media feature
