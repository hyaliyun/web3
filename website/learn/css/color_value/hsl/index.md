...
The `hsl()` function works well with [`conic-gradient()`](/Web/CSS/gradient/conic-gradient) as both deal with angles.
...
- [`lch()`](/Web/CSS/color_value/lch) and [`hwb()`](/Web/CSS/color_value/hwb) color functions
- [Hue interpolation in `color-mix()`](/Web/CSS/color_value/color-mix#using_hue_interpolation_in_color-mix)
- [List of all color notations](lor_value)
- [sRGB color picker and conversion tool](lor_picker_tool)
- [Using relative colors](S_colors/Relative_colors)
- [CSS colors](S_colors) module
