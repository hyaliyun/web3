...
The **`light-dark()`** [CSS](/Web/CSS) [`<color>` function](/Web/CSS/CSS_Functions#color_functions) enables setting two colors for a property - returning one of the two colors options by detecting if the developer has set a light or dark color scheme or the user has requested light or dark color theme - without needing to encase the theme colors within a [`prefers-color-scheme`](/Web/CSS/@media/prefers-color-scheme) [media feature](/Web/CSS/CSS_media_queries/Using_media_queries#targeting_media_features) query.
...
To enable support for the `light-dark()` color function, the {{CSSXref("color-scheme")}} must have a value of `light dark`, usually set on the {{CSSXref(":root")}} [pseudo-class](/Web/CSS/Pseudo-classes).
...
- `light-color`
  ...
  - :  value to be set for light {{CSSXref("color-scheme")}}.

- `dark-color`
  - :  value to be set for dark {{CSSXref("color-scheme")}}.
...
- [`prefers-contrast`](/Web/CSS/@media/prefers-contrast) {{cssxref("@media")}} feature
