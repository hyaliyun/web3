...
The **container** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property establishes the element as a query container and specifies the name and type of the [containment context](/Web/CSS/CSS_containment/Container_queries#naming_containment_contexts) used in a [container query](/Web/CSS/CSS_containment/Container_queries).
