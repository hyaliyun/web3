...
> **Note:** [Margin boxes](/Web/CSS/@page#margin_at-rules) and other positional elements have no special interaction with this descriptor. Margins are laid out as normal in the unrotated page, then rotated along with everything else.
...
In this first part of the CSS code, [named pages](/Web/CSS/@page#named_pages) are set up to define the direction in which to rotate the content.
