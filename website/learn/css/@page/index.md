...
- [`margin`](/Web/CSS/margin)
  - : Specifies the page margins. Individual margin properties [`margin-top`](/Web/CSS/margin-top), [`margin-right`](/Web/CSS/margin-right), [`margin-bottom`](/Web/CSS/margin-bottom), and [`margin-left`](/Web/CSS/margin-left) can also be used.
- [`page-orientation`](/Web/CSS/@page/page-orientation)
...
Named pages enable performing per-page layout and adding [page-breaks](/Web/CSS/CSS_fragmentation) in a declarative manner when printing.
...
An example of this can be found on the [`page`](/Web/CSS/page#examples) examples.
...
Please refer to the various [pseudo-classes](/Web/CSS/Pseudo-classes) of `@page` for examples.
...
- The `@page` [`size`](/Web/CSS/@page/size) descriptor
