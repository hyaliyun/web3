...
This page provides solutions to the challenges posed in the [CSS Getting Started](/Learn/CSS/First_steps) tutorial. These are not the only possible solutions. The sections below correspond to the titles of the tutorial sections.

## Why use CSS

The challenges on page [Why use CSS](/Learn/CSS/First_steps/How_CSS_works) are:
...
- Solution
  - : CSS supports common color names like `orange`, `yellow`, `blue`, `green`, or `black`. It also supports some more exotic color names like `chartreuse`, `fuschia`, or `burlywood`. See [CSS Color value](/Web/CSS/color_value) for a complete list as well as other ways of specifying colors.

## How CSS works

The challenges on page [How CSS works](/Learn/CSS/First_steps/How_CSS_works) are:
...
The challenges on page [Cascading and inheritance](/Learn/CSS/Building_blocks/Cascade_and_inheritance) are:
...
The challenges on page [Selectors](/Learn/CSS/Building_blocks/Selectors) are:
...
The challenges on page [Lists](/Learn/CSS/Styling_text/Styling_lists) are:
...
The challenges on page [Boxes](/Learn/CSS/Building_blocks) are:
...
The challenges on page [Layout](/Learn/CSS/CSS_layout) are:
...
The challenges on page [Tables](/Learn/CSS/Building_blocks/Styling_tables) are:
...
The challenges on page [Media](/Web/CSS/CSS_media_queries/Using_media_queries) are:
