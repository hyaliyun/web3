...
The **`stroke-width`** [CSS](/Web/CSS) property defines the width of a stroke applied to the [SVG](/Web/SVG) shape. If present, it overrides the element's {{SVGAttr("stroke-width")}} attribute.
