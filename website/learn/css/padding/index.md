...
The **`padding`** [CSS](/Web/CSS) [shorthand property](/Web/CSS/Shorthand_properties) sets the [padding area](/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#padding_area) on all four sides of an element at once.
...
- {{cssxref("&lt;percentage&gt;")}}
  - : The size of the padding as a percentage, relative to the inline size (_width_ in a horizontal language, defined by {{cssxref("writing-mode")}}) of the [containing block](/Web/CSS/Containing_block).
