...
The **`mask-border-repeat`** [CSS](/Web/CSS) property sets how the [edge regions](/Web/CSS/border-image-slice#edge-regions) of a source image are adjusted to fit the dimensions of an element's [mask border](/Web/CSS/mask-border).
