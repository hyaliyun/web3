...
The **`column-fill`** [CSS](/Web/CSS) property controls how an element's contents are balanced when broken into columns.
...
- `balance`
  - : Content is equally divided between columns. In fragmented contexts, such as [paged media](/Web/CSS/CSS_paged_media), only the last fragment is balanced. Therefore in paged media, only the last page would be balanced.
...
- [Multiple-column Layout](/Learn/CSS/CSS_layout/Multiple-column_Layout)
