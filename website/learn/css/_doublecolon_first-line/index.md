...
The **`::first-line`** [CSS](/Web/CSS) [pseudo-element](/Web/CSS/Pseudo-elements) applies styles to the first line of a [block container](/Web/CSS/Visual_formatting_model#block_containers).
...
> **Note:** [Selectors Level 3](https://drafts.csswg.org/selectors-3/#first-line) introduced the double-colon notation (`::`) to distinguish [pseudo-elements](/Web/CSS/Pseudo-elements) from the single-colon (`:`) [pseudo-classes](/Web/CSS/Pseudo-classes). Browsers accept both `::first-line` and `:first-line`, which was introduced in CSS2.
