...
The **`counter-increment`** [CSS](/Web/CSS) property can be used to increase or decrease the value of the named [CSS counters](/Web/CSS/CSS_counter_styles/Using_CSS_counters) by the specified values, or to prevent all counters or an individual counter's value from being changed.
