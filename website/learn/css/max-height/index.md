...
The **`max-height`** [CSS](/Web/CSS) property sets the maximum height of an element. It prevents the [used value](/Web/CSS/used_value) of the {{cssxref("height")}} property from becoming larger than the value specified for `max-height`.
