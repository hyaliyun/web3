...
The **`background-repeat`** [CSS](/Web/CSS) property sets how background images are repeated. A background image can be repeated along the horizontal and vertical axes, or not repeated at all.
...
- [CSS backgrounds and borders](/Web/CSS/CSS_backgrounds_and_borders/Using_multiple_backgrounds) module
