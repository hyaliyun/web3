...
The **`border-style`** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property sets the line style for all four sides of an element's border.
...
- [`border-bottom-style`](/Web/CSS/border-bottom-style)
- [`border-left-style`](/Web/CSS/border-left-style)
- [`border-right-style`](/Web/CSS/border-right-style)
