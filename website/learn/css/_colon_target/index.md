...
The **`:target`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) represents a unique element (the _target element_) with an [`id`](/Web/HTML/Global_attributes#id) matching the URL's fragment.
