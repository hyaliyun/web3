...
- [Learn forms: advanced form styling](/Learn/Forms/Advanced_form_styling)
  - : Explains how {{CSSxRef("appearance")}} can be used to style form controls.

## Related concepts

- CSS [`cursor`](/Web/CSS/cursor) property
- SVG [`cursor`](/Web/SVG/Attribute/cursor) attribute
