...
The **`padding-bottom`** [CSS](/Web/CSS) property sets the height of the [padding area](/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#padding_area) on the bottom of an element.
