...
- [Learn CSS: the box model](/Learn/CSS/Building_blocks/The_box_model)
...
- [`<color>`](/Web/CSS/color) data type
- [`<image>`](/Web/CSS/image) data type
- [`<position>`](/Web/CSS/position) data type

- [`currentcolor`](/Web/CSS/color_value#currentcolor_keyword) keyword
...
- [Applying color to HTML elements using CSS](/Web/CSS/CSS_colors/Applying_color), including for borders.
- The [`drop-shadow()`](/Web/CSS/filter-function/drop-shadow) filter function that applies a drop shadow effect to the input image. The function is used by the {{cssxref("filter")}} and {{cssxref("backdrop-filter")}} properties.
