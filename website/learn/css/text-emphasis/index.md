...
The **`text-emphasis`** [CSS](/Web/CSS) property applies emphasis marks to text (except spaces and control characters). It is a [shorthand](/Web/CSS/Shorthand_properties) for {{cssxref("text-emphasis-style")}} and {{cssxref("text-emphasis-color")}}.
...
- [`text-emphasis-color`](/Web/CSS/text-emphasis-color)
- [`text-emphasis-style`](/Web/CSS/text-emphasis-style)
