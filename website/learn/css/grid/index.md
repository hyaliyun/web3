...
The **`grid`** [CSS](/Web/CSS) property is a [shorthand property](/Web/CSS/Shorthand_properties) that sets all of the explicit and implicit grid properties in a single declaration.
...
- [`grid-auto-columns`](/Web/CSS/grid-auto-columns)
- [`grid-auto-flow`](/Web/CSS/grid-auto-flow)
- [`grid-auto-rows`](/Web/CSS/grid-auto-rows)
- [`grid-template-areas`](/Web/CSS/grid-template-areas)
- [`grid-template-columns`](/Web/CSS/grid-template-columns)
- [`grid-template-rows`](/Web/CSS/grid-template-rows)
