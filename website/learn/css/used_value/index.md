...
The **used value** of a [CSS](/Web/CSS) property is its value after all calculations have been performed on the [computed value](/Web/CSS/computed_value).
...
> [!NOTE]
> The {{domxref("Window.getComputedStyle", "getComputedStyle()")}} DOM API returns the [resolved value](/Web/CSS/resolved_value), which may either be the [computed value](/Web/CSS/computed_value) or the used value, depending on the property.
