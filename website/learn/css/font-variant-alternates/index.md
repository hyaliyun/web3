...
The **`font-variant-alternates`** [CSS](/Web/CSS) property controls the usage of alternate glyphs. These alternate glyphs may be referenced by alternative names defined in {{cssxref("@font-feature-values")}}.
...
- [`@font-feature-values`](/Web/CSS/@font-feature-values)
- [`font-feature-settings`](/Web/CSS/font-feature-settings)
