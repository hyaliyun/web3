...
The **`font-display`** descriptor for the [`@font-face`](/Web/CSS/@font-face) at-rule determines how a font face is displayed based on whether and when it is downloaded and ready to use.
