...
The **`-webkit-text-fill-color`** [CSS](/Web/CSS) property specifies the fill [color](/Web/CSS/color_value) of characters of text. If this property is not set, the value of the {{cssxref("color")}} property is used.
