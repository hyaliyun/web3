...
The **`empty-cells`** [CSS](/Web/CSS) property sets whether borders and backgrounds appear around {{htmlelement("table")}} cells that have no visible content.
...
- [Styling tables](/Learn/CSS/Building_blocks/Styling_tables)
