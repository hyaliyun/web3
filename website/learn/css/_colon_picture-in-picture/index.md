...
The **`:picture-in-picture`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) matches the element which is currently in picture-in-picture mode.
...
- [Picture-in-picture API](/Web/API/Picture-in-Picture_API)
