...
The **`place-content`** [CSS](/Web/CSS) [shorthand property](/Web/CSS/Shorthand_properties) allows you to align content along both the block and inline directions at once (i.e. the {{CSSxRef("align-content")}} and {{CSSxRef("justify-content")}} properties) in a relevant layout system such as [Grid](/Web/CSS/CSS_grid_layout) or [Flexbox](/Web/CSS/CSS_flexible_box_layout).
...
- [`align-content`](/Web/CSS/align-content)
- [`justify-content`](/Web/CSS/justify-content)
