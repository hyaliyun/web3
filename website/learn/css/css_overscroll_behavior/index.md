...
- [Containing block](/Web/CSS/Containing_block) concept
...
- {{Glossary("Scroll_container", "Scroll container")}} and [scrollport](/Glossary/Scroll_container#scrollport) glossary terms
