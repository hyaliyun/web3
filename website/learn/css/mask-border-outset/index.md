...
The **`mask-border-outset`** [CSS](/Web/CSS) property specifies the distance by which an element's [mask border](/Web/CSS/mask-border) is set out from its border box.
