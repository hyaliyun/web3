...
The **`::grammar-error`** [CSS](/Web/CSS) [pseudo-element](/Web/CSS/Pseudo-elements) represents a text segment which the {{glossary("user agent")}} has flagged as grammatically incorrect.
