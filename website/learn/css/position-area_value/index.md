...
The **`<position-area>`** [CSS](/Web/CSS) [data type](/Web/CSS/CSS_Types) defines the cell or spanned cells of a **position-area grid**, a 3x3 grid whose center cell is an anchor element.
...
- [`anchor()`](/Web/CSS/anchor) function
