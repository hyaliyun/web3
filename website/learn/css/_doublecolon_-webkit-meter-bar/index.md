...
The **`::-webkit-meter-bar`** [CSS](/Web/CSS) [pseudo-element](/Glossary/Pseudo-element) is a [WebKit extension](/Web/CSS/WebKit_Extensions) that represents the background of a {{HTMLElement("meter")}} element. It is used for selecting and applying styles to the container of a meter gauge.
