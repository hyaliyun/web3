...
The **`stroke-dasharray`** [CSS](/Web/CSS) property defines a pattern of dashes and gaps used in the painting of the [SVG](/Web/SVG) shape's stroke. If present, it overrides the element's {{SVGAttr("stroke-dasharray")}} attribute.
