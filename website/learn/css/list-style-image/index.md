...
The **`list-style-image`** [CSS](/Web/CSS) property sets an image to be used as the list item marker.
...
This example has a [CSS gradient](/Web/CSS/CSS_images/Using_CSS_gradients) as a marker, which we create uses the {{cssxref("gradient/linear-gradient", "linear-gradient()")}} image function.
