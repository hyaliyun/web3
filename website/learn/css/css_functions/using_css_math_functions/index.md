...
Without using any math, the built-in [CSS units](/Learn/CSS/Building_blocks/Values_and_units) like `rem`, `vw`, and `%` are often flexible enough to style HTML elements to achieve a particular user experience.
...
In total, developers can use a combination of [nearly two dozen CSS math functions](/Web/CSS/CSS_Functions#math_functions) in their stylesheets. In this guide, we'll exemplify four of the more commonly-used, and introduce those more advanced.
...
- [Stepped value functions](/Web/CSS/CSS_Functions#stepped_value_functions)
...
- [Trigonometric functions](/Web/CSS/CSS_Functions#trigonometric_functions)
...
- [Exponential functions](/Web/CSS/CSS_Functions#exponential_functions)
...
- [Sign functions](/Web/CSS/CSS_Functions#sign-related_functions)
...
- CSS math functions can sometimes be used instead of [CSS media queries](/Web/CSS/CSS_media_queries/Using_media_queries) to define layout breakpoints.
