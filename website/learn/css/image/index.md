...
The **`<image>`** [CSS](/Web/CSS) [data type](/Web/CSS/CSS_Types) represents a two-dimensional image.
...
- Generated by a [paint worklet](/Web/API/CSS_Painting_API) with the {{CSSxRef("image/paint","paint()")}} function.
