...
The **`paint()`** [CSS](/Web/CSS) [function](/Web/CSS/CSS_Functions) defines an {{cssxref("&lt;image&gt;")}} value generated with a PaintWorklet.
...
In JavaScript, we register the [paint worklet](/Web/API/PaintWorkletGlobalScope):
