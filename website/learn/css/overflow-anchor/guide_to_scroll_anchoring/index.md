...
If you need to test whether scroll anchoring is available in a browser, use [Feature Queries](/Web/CSS/@supports) to test support for the `overflow-anchor` property.
