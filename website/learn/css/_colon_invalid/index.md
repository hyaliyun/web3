...
The **`:invalid`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) represents any {{HTMLElement("form")}}, {{HTMLElement("fieldset")}},  or other {{HTMLElement("form")}} element whose contents fail to [validate](/Web/HTML/Constraint_validation).
...
- Accessing the [validity state](/Web/API/ValidityState) from JavaScript
