...
When using a stylus or a pointer, the {{domxref("Touch.clientX")}} and {{domxref("Touch.clientY")}} coordinates in a [touch event](/Web/API/TouchEvent) are relative to the same origin.
...
{{domxref("Touch.pageX")}} and {{domxref("Touch.pageY")}} coordinates in a [touch event](/Web/API/TouchEvent) are relative to the same origin.
...
{{domxref("Touch.screenX")}} and {{domxref("Touch.screenY")}} coordinates in a [touch event](/Web/API/TouchEvent) are relative to the same origin.
...
- [Using CSS transforms](/Web/CSS/CSS_transforms/Using_CSS_transforms): how to alter a coordinate system
