...
The **`-moz-image-rect`** value for [CSS](/Web/CSS) {{CSSxRef("background-image")}} lets you use a portion of a larger image as a background.
...
The syntax for the rectangle is similar to the [`rect()`](/Web/CSS/shape#syntax) function generating a {{CSSxRef("&lt;shape&gt;")}} CSS type. All four values are relative to the upper left corner of the image.
...
- [CSS Backgrounds and Borders module](/Web/CSS/CSS_backgrounds_and_borders)
