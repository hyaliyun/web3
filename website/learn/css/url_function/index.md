...
[src](/Web/CSS/@font-face/src) as part of a [`@font-face`](/Web/CSS/@font-face) block, and [@counter-style/`symbol`](/Web/CSS/@counter-style/symbols)
...
- `<string>`
  ...
  - : A string that may specify a URL or the ID of an SVG shape.
    ...
    - path
      - : References the ID of an [SVG shape](/Web/SVG/Tutorial/Basic_Shapes) or an [SVG filter](/Web/SVG/Element/filter).
