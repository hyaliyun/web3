...
The **`-webkit-text-stroke-color`** [CSS](/Web/CSS) property specifies the stroke [color](/Web/CSS/color_value) of characters of text. If this property is not set, the value of the {{cssxref("color")}} property is used.
