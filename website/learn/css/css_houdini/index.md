...
A regular [CSS custom property](/Web/CSS/--*) consists of a property name and a value. Therefore I might create a custom property called `--background-color` and expect it to be given a color value. The value is then used in the CSS as if it were the color value.
...
- [Properties and Values API Guide](/Web/API/CSS_Properties_and_Values_API/guide)
- [Typed OM API Guide](/Web/API/CSS_Typed_OM_API/Guide)
- [Using the CSS Painting API](/Web/API/CSS_Painting_API/Guide)
