...
The **`animation-range`** [CSS](/Web/CSS) [shorthand property](/Web/CSS/Shorthand_properties) is used to set the start and end of an animation's attachment range along its timeline, i.e. where along the timeline an animation will start and end.

## Constituent properties

This property is a shorthand for the following CSS properties:

- [`animation-range-start`](/Web/CSS/animation-range-start)
- [`animation-range-end`](/Web/CSS/animation-range-end)
...
One or two values representing the [`animation-range-start`](/Web/CSS/animation-range-start) and/or [`animation-range-end`](/Web/CSS/animation-range-end). These values can be one of the following:
...
- [`animation-range-end`](/Web/CSS/animation-range-end), [`animation-range-start`](/Web/CSS/animation-range-start)
