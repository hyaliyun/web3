...
The most commonly-used types are defined in the [CSS Values and Units](/Web/CSS/CSS_Values_and_Units) specification. This specification also defines [functional notations](/Web/CSS/CSS_Functions), which allow for more complex types or processing. Other types are defined in the specifications to which they apply.
...
- {{cssxref("&lt;dashed-ident&gt;")}}
  - : A `<custom-ident>` with the additional restriction that it must start with two dashes, for example, with [CSS Custom Properties](/Web/CSS/Using_CSS_custom_properties).
- {{cssxref("&lt;string&gt;")}}
...
- {{cssxref("&lt;flex&gt;")}}
  - : A flexible length introduced for [CSS grid layout](/Web/CSS/CSS_grid_layout), written as a `<number>` with the `fr` unit attached and used for grid track sizing.
...
[The CSS Color Specification](https://www.w3.org/TR/css-color-4/) defines the  data type, and other types which relate to color in CSS.
...
These data types are used in [CSS math function](/Web/CSS/CSS_Functions#math_functions) calculations.
...
- [CSS Units and Values](/Web/CSS/CSS_Values_and_Units)
- [Introduction to CSS: Values and Units](/Learn/CSS/Building_blocks/Values_and_units)
- [CSS Functional Notation](/Web/CSS/CSS_Functions)
