...
The **`:nth-last-of-type()`** [CSS](/Web/CSS) [pseudo-class](/Web/CSS/Pseudo-classes) matches elements based on their position among siblings of the same type (tag name), counting from the end.
