...
The **`forced-color-adjust`** [CSS](/Web/CSS) property allows authors to opt certain elements out of forced colors mode. This then restores the control of those values to CSS.
...
By using the [`forced-colors`](/Web/CSS/@media/forced-colors) media feature you could add any other optimizations for forced color mode alongside the `forced-color-adjust` property.
