...
The **`contain-intrinsic-height`** [CSS](/Web/CSS) property sets the height of an element that a browser can use for layout when the element is subject to [size containment](/Web/CSS/CSS_containment/Using_CSS_containment#size_containment).
