...
The **`border-width`** [shorthand](/Web/CSS/Shorthand_properties) [CSS](/Web/CSS) property sets the width of an element's border.
...
- [`border-bottom-width`](/Web/CSS/border-bottom-width)
- [`border-left-width`](/Web/CSS/border-left-width)
- [`border-right-width`](/Web/CSS/border-right-width)
