...
- {{cssxref("revert-layer")}}
  - : Rolls back the value of a property in a [cascade layer](/Web/CSS/@layer) to the value of the property in a CSS rule matching the element in a previous cascade layer. The value of the property with this keyword is recalculated as if no rules were specified on the target element in the current cascade layer.
...
Root font-relative lengths specify a length in relation to the element's [root element](/Web/CSS/:root) ancestor, such as {{HTMLElement("HTML")}} or {{SVGElement("SVG")}}.
...
Viewport unit lengths specify a length relative to the dimensions of the [viewport](/Glossary/Viewport).
For example, `vw` is relative to the width of the viewport and `vh` is relative to the height of the viewport.

| Unit   | Relative to                                                                                           |
| ------ | ----------------------------------------------------------------------------------------------------- |
| `dvh`  | 1% of the [dynamic](/Web/CSS/length#dynamic) viewport's height.                            |
| `dvw`  | 1% of the [dynamic](/Web/CSS/length#dynamic) viewport's width.                             |
| `lvh`  | 1% of the [large](/Web/CSS/length#large) viewport's height.                                |
| `lvw`  | 1% of the [large](/Web/CSS/length#large) viewport's width.                                 |
| `svh`  | 1% of the [small](/Web/CSS/length#small) viewport's height.                                |
| `svw`  | 1% of the [small](/Web/CSS/length#small) viewport's width.                                 |
| `vb`   | 1% of viewport's size in the root element's [block axis](/Glossary/Flow_relative_values).  |
| `vh`   | 1% of viewport's height.                                                                              |
| `vi`   | 1% of viewport's size in the root element's [inline axis](/Glossary/Flow_relative_values). |
...
Container query length units specify a length relative to the dimensions of a [query container](/Web/CSS/CSS_containment/Container_queries).
...
The  value specifies the color of an element feature (e.g. it's background color), and is defined in the [CSS Color Module](https://drafts.csswg.org/css-color-3/).
...
- [CSS Basic Data Types](/Web/CSS/CSS_Types)
