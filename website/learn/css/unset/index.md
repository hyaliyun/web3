...
The **`unset`** CSS keyword resets a property to its inherited value if the property naturally inherits from its parent, and to its [initial value](/Web/CSS/initial_value) if not. In other words, it behaves like the {{cssxref("inherit")}} keyword in the first case, when the property is an [inherited property](/Web/CSS/Inheritance#inherited_properties), and like the {{cssxref("initial")}} keyword in the second case, when the property is a [non-inherited property](/Web/CSS/Inheritance#non-inherited_properties).
...
[`color`](/Web/CSS/color#formal_definition) is an inherited property.
...
[`border`](/Web/CSS/border#formal_definition) is a non-inherited property.
