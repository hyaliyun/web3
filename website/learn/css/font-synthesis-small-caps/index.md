...
The **`font-synthesis-small-caps`** [CSS](/Web/CSS) property lets you specify whether or not the browser may synthesize small-caps typeface when it is missing in a font family. Small-caps glyphs typically use the form of uppercase letters but are reduced to the size of lowercase letters.
...
- [font-synthesis](/Web/CSS/font-synthesis) shorthand, [font-synthesis-style](/Web/CSS/font-synthesis-style), [font-synthesis-weight](/Web/CSS/font-synthesis-weight)
- {{cssxref("font-style")}}, {{cssxref("font-variant")}}, {{cssxref("font-variant-caps")}}, {{cssxref("font-weight")}}
- [CanvasRenderingContext2D: fontVariantCaps property](/Web/API/CanvasRenderingContext2D/fontVariantCaps)
