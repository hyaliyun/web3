...
Some basic CSS is used to style the table and its cells. We use CSS [attribute selectors](/Web/CSS/Attribute_selectors) to target header cells based on their [`scope`](#scope) attribute values, highlighting column and row headers (`<th>` elements) and differentiating them each other and from the data cells ({{HTMLElement("td")}}).
...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/Accessibility/ARIA/Roles/columnheader_role"><code>columnheader</code></a> or <a href="/Web/Accessibility/ARIA/Roles/rowheader_role"><code>rowheader</code></a>
      </td>
    </tr>
    <tr>
