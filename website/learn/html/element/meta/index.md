...
- If the [`itemprop`](/Web/HTML/Global_attributes/itemprop) attribute is set, the `<meta>` element provides _user-defined metadata_.
...
> [!NOTE]
> The attribute [`name`](#name) has a specific meaning for the `<meta>` element, and the [`itemprop`](/Web/HTML/Global_attributes/itemprop) attribute must not be set on the same `<meta>` element that has any existing [`name`](#name), [`http-equiv`](#http-equiv) or [`charset`](#charset) attributes.
  ...
  - : Defines a pragma directive. The attribute's name, short for `http-equivalent`, is because all the allowed values are names of particular HTTP headers:
    ...
    - `refresh`
      ...
      - : This instruction specifies:
        ...
        >
        > - [MDN Understanding WCAG, Guideline 2.2 explanations](/Web/Accessibility/Understanding_WCAG/Operable#guideline_2.2_—_enough_time_provide_users_enough_time_to_read_and_use_content)
        > - [MDN Understanding WCAG, Guideline 3.2 explanations](/Web/Accessibility/Understanding_WCAG/Understandable#guideline_3.2_—_predictable_make_web_pages_appear_and_operate_in_predictable_ways)
...
- `name`
  ...
  - : The `name` and `content` attributes can be used together to provide document metadata in terms of name-value pairs, with the `name` attribute giving the metadata name, and the `content` attribute giving the value.
    ...
    See [standard metadata names](/Web/HTML/Element/meta/name) for details about the set of standard metadata names defined in the HTML specification.
    ...
    <tr>
      ...
      <td>
        <a href="/Web/HTML/Content_categories#metadata_content"
          >Metadata content</a
        >. If the <a href="/Web/HTML/Global_attributes/itemprop"><code>itemprop</code></a> attribute is present:
      ...
      <td>
        <ul>
          ...
          <li>
            ...
            <a
              href="/Web/HTML/Content_categories#metadata_content"
              >metadata content</a
            >.
          </li>
          <li>
...
- [Standard metadata names](/Web/HTML/Element/meta/name)
- [Learn: `<meta>`](/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML#metadata_the_meta_element)
- [The viewport meta tag](/Web/HTML/Viewport_meta_tag)
