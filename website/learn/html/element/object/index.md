...
- `type`
  - : The [content type](/Glossary/MIME_type) of the resource specified by **data**. At least one of **data** and **type** must be defined.
- `usemap` {{deprecated_inline}}
  - : A hash-name reference to a {{HTMLElement("map")}} element; that is a '#' followed by the value of a [`name`](/Web/HTML/Element/map#name) of a map element.
- `width`
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <a href="/Web/HTML/Content_categories#embedded_content">embedded content</a>, palpable content; if the element has a
        <a href="#usemap"><code>usemap</code></a> attribute, <a href="/Web/HTML/Content_categories#interactive_content">interactive content</a>;
        <a href="/Web/HTML/Content_categories#form_listed">listed</a>,
        <a href="/Web/HTML/Content_categories#form_submittable">submittable</a>
        <a href="/Web/HTML/Content_categories#form-associated_content">form-associated</a> element.
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <a href="/Web/HTML/Content_categories#transparent_content_model">transparent</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        Any element that accepts <a href="/Web/HTML/Content_categories#embedded_content">embedded content</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <a href="/Web/Accessibility/ARIA/Roles/application_role"><code>application</code></a>, <a href="/Web/Accessibility/ARIA/Roles/document_role"><code>document</code></a>, <a href="/Web/Accessibility/ARIA/Roles/img_role"><code>img</code></a>
      </td>
    </tr>
    <tr>
