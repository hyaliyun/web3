...
The **`<section>`** [HTML](/Web/HTML) element represents a generic standalone section of a document, which doesn't have a more specific semantic element to represent it. Sections should always have a heading, with very few exceptions.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        >,
        <a
          href="/Web/HTML/Content_categories#sectioning_content"
    ...
    <tr>
      ...
      <td>
        <a href="/Web/Accessibility/ARIA/Roles/alert_role"><code>alert</code></a>, <a href="/Web/Accessibility/ARIA/Roles/alertdialog_role"><code>alertdialog</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/application_role"><code>application</code></a>, <a href="/Web/Accessibility/ARIA/Roles/banner_role"><code>banner</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/complementary_role"><code>complementary</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/contentinfo_role"><code>contentinfo</code></a>, <a href="/Web/Accessibility/ARIA/Roles/dialog_role"><code>dialog</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/document_role"><code>document</code></a>, <a href="/Web/Accessibility/ARIA/Roles/feed_role"><code>feed</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/log_role"><code>log</code></a>, <a href="/Web/Accessibility/ARIA/Roles/main_role"><code>main</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/marquee_role"><code>marquee</code></a>, <a href="/Web/Accessibility/ARIA/Roles/navigation_role"><code>navigation</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/none_role"><code>none</code></a>, <a href="/Web/Accessibility/ARIA/Roles/note_role"><code>note</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/presentation_role"><code>presentation</code></a>, <a href="/Web/Accessibility/ARIA/Roles/search_role"><code>search</code></a>,
        <a href="/Web/Accessibility/ARIA/Roles/status_role"><code>status</code></a>, <a href="/Web/Accessibility/ARIA/Roles/tabpanel_role"><code>tabpanel</code></a>
      </td>
    </tr>
    <tr>
