...
Use the **HTML `<canvas>` element** with either the [canvas scripting API](/Web/API/Canvas_API) or the [WebGL API](/Web/API/WebGL_API) to draw graphics and animations.
...
The benefit is that a [worker thread](/Web/API/Web_Workers_API/Using_web_workers) can handle canvas rendering and the main thread of your web application is not blocked by canvas operations.
    ...
    <tr>
      ...
      <td>
        ...
        {{HTMLElement("button")}} elements,
         elements whose
        <a href="/Web/HTML/Element/input#type"><code>type</code></a> attribute is
...
- [OffscreenCanvas](/Web/API/OffscreenCanvas)
