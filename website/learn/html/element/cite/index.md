...
To include a reference to the source of quoted material which is contained within a {{HTMLElement("blockquote")}} or {{HTMLElement("q")}} element, use the [`cite`](/Web/HTML/Element/blockquote#cite) attribute on the element.
...
- The element {{HTMLElement("q")}} for inline quotations and the [`cite`](/Web/HTML/Element/q#cite) attribute.
