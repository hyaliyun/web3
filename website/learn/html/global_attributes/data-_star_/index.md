...
The **`data-*`** [global attributes](/Web/HTML/Global_attributes) form a class of attributes called **custom data attributes**, that allow proprietary information to be exchanged between the [HTML](/Web/HTML) and its [DOM](/Web/API/Document_Object_Model) representation by scripts.
...
For a more in-depth tutorial about using HTML data attributes, see [Using data attributes](/Learn/HTML/Howto/Use_data_attributes).
