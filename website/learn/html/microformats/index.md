...
<div class="h-entry">
  <p>
    ...
    <a
      class="u-in-reply-to"
      href="https://developer.mozilla.org/Web/HTML/microformats">
  ...
  "items": [
    {
      ...
      "properties": {
        "in-reply-to": [
          "https://developer.mozilla.org/Web/HTML/microformats"
        ],
...
- [class attribute](/Web/HTML/Global_attributes/class)
