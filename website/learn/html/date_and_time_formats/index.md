...
Elements that use such formats include certain forms of the  element that let the user choose or specify a date, time, or both, as well as the {{HTMLElement("ins")}} and {{HTMLElement("del")}} elements, whose [`datetime`](/Web/HTML/Element/ins#datetime) attribute specifies the date or date and time at which the insertion or deletion of content occurred.

For `<input>`, the [`type`](/Web/HTML/Element/input#type) values of inputs whose [`value`](/Web/HTML/Element/input#value) contains a string representing a date and/or time are:

- [`date`](/Web/HTML/Element/input/date)
- [`datetime-local`](/Web/HTML/Element/input/datetime-local)
- [`month`](/Web/HTML/Element/input/month)
- [`time`](/Web/HTML/Element/input/time)
- [`week`](/Web/HTML/Element/input/week)
...
- [Numbers and Dates](/Web/JavaScript/Guide/Numbers_and_dates) in the [JavaScript Guide](/Web/JavaScript/Guide)
- The JavaScript  object
- The [`Intl.DateTimeFormat`](/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat) object for formatting dates and times for a given locale
