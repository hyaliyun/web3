...
```html
<form action="/Web/HTML/Attributes/placeholder">
...
- HTML [`title`](/Web/HTML/Global_attributes/title)
- CSS [`:placeholder-shown`](/Web/CSS/:placeholder-shown) pseudo-class selector
- CSS [`::placeholder`](/Web/CSS/::placeholder) pseudo-element selector
