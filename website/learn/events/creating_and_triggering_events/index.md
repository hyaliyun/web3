...
Events can be created with the [`Event`](/Web/API/Event) constructor as follows:
...
The above code example uses the [EventTarget.dispatchEvent()](/Web/API/EventTarget/dispatchEvent) method.
...
To add more data to the event object, the [CustomEvent](/Web/API/CustomEvent) interface exists and the **detail** property can be used to pass custom data.
...
- [CustomEvent()](/Web/API/CustomEvent/CustomEvent)
...
<section id="Quick_links">
  <ol>
    ...
    <li><a href="/Web/Events/Event_handlers">Event handlers (overview)</a></li>
