...
- `expression`
  - : The expression is evaluated exactly as if it were passed as an argument to the [boolean()](/Web/XPath/Functions/boolean) function.
...
- This function should behave similarly to the [boolean()](/Web/XPath/Functions/boolean) function except that it returns the opposite value.
