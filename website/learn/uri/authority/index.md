...
The **authority** of a URI is the section that comes after the [scheme](/Web/URI/Schemes) and before the path. It may have up to three parts: user information, host, and port.
...
- [URIs](/Web/URI)
- [Choosing between www and non-www URLs](/Web/URI/Authority/Choosing_between_www_and_non-www_URLs)
