...
- You can link to the top of a document by linking to its URL, for example:
  - [https://developer.mozilla.org/Web/HTML/Element/a](/Web/HTML/Element/a).
- You can link to a specific section of a document by linking to its URL plus the _document fragment_ (ID) of that section, for example:
  - [https://developer.mozilla.org/Web/HTML/Element/a#browser_compatibility](/Web/HTML/Element/a#browser_compatibility).
...
- Text strings used for the `textStart`, `textEnd`, `prefix-`, and `-suffix` values need to be [percent-encoded](/Web/JavaScript/Reference/Global_Objects/encodeURIComponent).
- Matches are case-insensitive.
- Individual `textStart`, `textEnd`, `prefix-`, and `-suffix` strings need to reside wholly inside the same [block-level element](/Glossary/Block-level_content), but complete matches can span across multiple element boundaries.
...
- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=human](/Web/HTML/Element/a#:~:text=human) scrolls to and highlights the first instance of the text `human` in the document.
- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=linked%20URL](/Web/HTML/Element/a#:~:text=linked%20URL) scrolls to and highlights the first instance of the text `linked URL` in the document.

### textStart and textEnd

- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=human,URL](/Web/HTML/Element/a#:~:text=human,url) scrolls to and highlights the first instance of a text string starting with `human` and ending with `URL`.
- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=linked%20URL,defining%20a%20value](/Web/HTML/Element/a#:~:text=linked%20URL,defining%20a%20value) scrolls to and highlights the first instance of a text string starting with `linked URL` and ending with `defining a value`. Note how the highlighted text spans across multiple block-level elements.
...
- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=Causes&text=linked](/Web/HTML/Element/a#:~:text=causes&text=linked) scrolls to and highlights the first instances of the text strings `Causes` and `linked`.
- [https://developer.mozilla.org/Web/HTML/Element/a#:~:text=linked%20URL,-'s%20format&text=Deprecated-,attributes,attribute](/Web/HTML/Element/a#:~:text=linked%20URL,-'s%20format&text=Deprecated-,attributes,attribute) scrolls to and highlights two text instances:
