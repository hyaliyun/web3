...
In such cases, a {{HTTPStatus("405", "405 Method Not Allowed")}} [client error response](/Web/HTTP/Status#client_error_responses) will be sent.
...
<table class="properties">
  <tbody>
    ...
    <tr>
      <th scope="row">Allowed in <a href="/Learn/Forms">HTML forms</a></th>
      <td>No</td>
    </tr>
  </tbody>
</table>
