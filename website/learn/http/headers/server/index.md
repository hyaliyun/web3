...
Historically, clients have used the server version information to avoid known limitations, such as inconsistent support for [range requests](/Web/HTTP/Range_requests) in specific software versions.
