...
- a [`400 Bad Request`](/Web/HTTP/Status/400) error, and include another `Want-Digest` header with that response, listing the algorithms that it does support.
...
- \<q-value>
  - : The [quality value](/Glossary/Quality_values) to apply to that
    option.
