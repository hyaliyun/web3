...
The request header is automatically added and populated by the browser using values specified by the application in the [`protocols`](/Web/API/WebSocket/WebSocket#protocols) argument to the `WebSocket()`.
...
The sub-protocol is specified in the original WebSocket [handshake request](/Web/API/WebSockets_API/Writing_WebSocket_servers#the_websocket_handshake).
...
- [The WebSocket handshake](/Web/API/WebSockets_API/Writing_WebSocket_servers#the_websocket_handshake) and [Subprotocols](/Web/API/WebSockets_API/Writing_WebSocket_servers#subprotocols) in _Writing WebSocket servers_
