...
transmitted as the result of [content negotiation](/Web/HTTP/Content_negotiation).
...
- \<url>
  - : A [relative](/Learn/Common_questions/Web_mechanics/What_is_a_URL#absolute_urls_vs._relative_urls)
    (to the request URL) or [absolute](/Learn/Common_questions/Web_mechanics/What_is_a_URL#absolute_urls_vs._relative_urls)
    URL.
...
patterns it wishes, such as a [query string parameter](/Web/API/HTMLAnchorElement/search): `/documents/foo?format=json`,
...
The server could also consider other [content negotiation](/Web/HTTP/Content_negotiation) headers, such
...
Say you have a
[`<form>`](/Web/HTML/Element/form) for sending
