...
| 113  | Heuristic Expiration             | A cache heuristically chose a [freshness lifetime](/Web/HTTP/Caching#fresh_and_stale_based_on_age) greater than 24 hours and the age of the response is greater than 24 hours. |
