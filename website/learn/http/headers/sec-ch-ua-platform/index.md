...
The **`Sec-CH-UA-Platform`** [user agent client hint](/Web/HTTP/Client_hints#user-agent_client_hints) request header provides the platform or operating system on which the user agent is running.
For example: "Windows" or "Android".

`Sec-CH-UA-Platform` is a [low entropy hint](/Web/HTTP/Client_hints#low_entropy_hints).
...
As `Sec-CH-UA-Platform` is a [low entropy hint](/Web/HTTP/Client_hints#low_entropy_hints) it is typically sent in all requests.
