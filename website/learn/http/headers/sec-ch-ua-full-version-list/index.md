...
The **`Sec-CH-UA-Full-Version-List`** [user agent client hint](/Web/HTTP/Client_hints#user-agent_client_hints) request header provides the user-agent's branding and full version information.
