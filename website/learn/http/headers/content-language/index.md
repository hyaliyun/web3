...
The global [`lang`](/Web/HTML/Global_attributes/lang) attribute is used on HTML elements to indicate the language of an entire [HTML](/Web/HTML) document or parts of it.
...
- [HTML `lang` attribute](/Web/HTML/Global_attributes/lang)
