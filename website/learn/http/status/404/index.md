...
The HTTP **`404 Not Found`** [client error response](/Web/HTTP/Status#client_error_responses) status code indicates that the server cannot find the requested resource.
...
For more information, see the [Redirections in HTTP](/Web/HTTP/Redirections) guide.
