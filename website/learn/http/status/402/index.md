...
The HTTP **`402 Payment Required`** [client error response](/Web/HTTP/Status#client_error_responses) status code is a **nonstandard** response status code reserved for future use.
