...
The HTTP **`100 Continue`** [informational response](/Web/HTTP/Status#information_responses) status code indicates that the initial part of a request has been received and has not yet been rejected by the server.
