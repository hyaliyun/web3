...
The HTTP **`206 Partial Content`** [successful response](/Web/HTTP/Status#successful_responses) status code is sent in response to a [range request](/Web/HTTP/Range_requests).
