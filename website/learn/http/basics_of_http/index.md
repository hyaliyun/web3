...
- [MIME types](/Web/HTTP/Basics_of_HTTP/MIME_types)
...
- [Frame and message structure in HTTP/2](/Web/HTTP/Frame_and_message_structure_in_HTTP_2)
...
- [Connection management in HTTP/1.x](/Web/HTTP/Connection_management_in_HTTP_1.x)
...
- [Connection management in HTTP/2](/Web/HTTP/Connection_management_in_HTTP_2)
...
- [Content Negotiation](/Web/HTTP/Content_negotiation)
  - : HTTP introduces a set of headers, starting with [`Accept`](/Web/HTTP/Headers/Accept) as a way for a browser to announce the format, language, or encoding it prefers. This article explains how this advertisement happens, how the server is expected to react, and how it chooses the most adequate response.
