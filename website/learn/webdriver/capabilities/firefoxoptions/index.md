...
[`alwaysMatch`](/Web/WebDriver/Capabilities#alwaysmatch) or as a member of one of the
[`firstMatch`](/Web/WebDriver/Capabilities#firstmatch) entries.
...
capability in the [new session response](/Web/WebDriver/Commands/NewSession).
...
The following is an example of a full [capabilities object](/Web/WebDriver/Capabilities) that
...
[`alwaysMatch`](/Web/WebDriver/Capabilities#alwaysmatch), or in one of the
[`firstMatch`](/Web/WebDriver/Capabilities#firstmatch) [capabilities objects](/Web/WebDriver/Capabilities) as seen here:
