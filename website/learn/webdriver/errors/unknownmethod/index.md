...
The **unknown method** error is a [WebDriver error](/Web/WebDriver/Errors) that occurs when the driver does not recognize the [HTTP request method](/Web/HTTP/Methods) used for the endpoint.
