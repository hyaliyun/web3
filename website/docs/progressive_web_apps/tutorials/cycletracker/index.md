...
We will first cover the steps of building a fully functional web app, then progressively enhance CycleTracker to [make it installable](/Web/Progressive_web_apps/Guides/Making_PWAs_installable), and to work even when the user is offline.
...
- Easy for the user to install
  ...
  - : Historically, downloaded single-OS-only applications have to be intentionally installed by the user. Depending on the OS, install format, and download origin, this can be a multi-step installation process. PWAs are streamlined. PWAs are available to anyone with a supporting browser, and are [installable](/Web/Progressive_web_apps/Guides/Installing) with a couple of clicks.
...
- [App HTML and CSS](/Web/Progressive_web_apps/Tutorials/CycleTracker/HTML_and_CSS)
...
- [Local development environment or secure connection](/Web/Progressive_web_apps/Tutorials/CycleTracker/Secure_connection)
...
- [JavaScript and LocalStorage](/Web/Progressive_web_apps/Tutorials/CycleTracker/JavaScript_functionality)

  - : Full explanation of the JavaScript functionality to make a client-side period tracker web application so we have a functioning application that can be progressively enhanced into a PWA, using [`localStorage`](/Web/API/Window/localStorage) to store period information.

- [Manifest: identity, appearance, and iconography](/Web/Progressive_web_apps/Tutorials/CycleTracker/Manifest_file)
...
- [Service workers](/Web/Progressive_web_apps/Tutorials/CycleTracker/Service_workers)
...
- [Offline experience](/Web/Progressive_web_apps/Tutorials/CycleTracker/offline)
...
- [Session storage](/Web/Progressive_web_apps/Tutorials/CycleTracker/Storage)
