...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/Web/Media/Formats/Containers#mpeg-4_mp4">MP4</a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Theora</td>
      <td><a href="/Web/Media/Formats/Containers#ogg">Ogg</a></td>
    </tr>
    <tr>
...
The **AOMedia Video 1** (**AV1**) codec is an open format designed by the [Alliance for Open Media](https://aomedia.org/) specifically for internet video. It achieves higher data compression rates than [VP9](#vp9) and [H.265/HEVC](#hevc_h.265), and as much as 50% higher rates than [AVC](#avc_h.264). AV1 is fully royalty-free and is designed for use by both the {{HTMLElement("video")}} element and by [WebRTC](/Web/API/WebRTC_API).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        >, MPEG-TS,
        <a href="/Web/Media/Formats/Containers#mpeg-4_mp4">MP4</a>
        <a href="/Web/Media/Formats/Containers#quicktime">QuickTime</a>
      </td>
    </tr>
    <tr>
      <th scope="row">
...
Its primary purpose is to be used to stream MPEG-4 audio and video over an {{Glossary("RTP")}} session. However, MP4V-ES is also used to transmit MPEG-4 audio and video over a mobile connection using [3GP](/Web/Media/Formats/Containers#3gp).
...
There is good browser support for VP8 in HTML content, especially within [WebM](/Web/Media/Formats/Containers#webm) files.
...
VP9 is one of the two video codecs mandated by [WebM](/Web/Media/Formats/Containers#webm) (the other being [VP8](#vp8)).
...
<table class="standard-table">
  <tbody>
    ...
    <tr>
      <th scope="row">
        {{Glossary("RTP")}} / <a href="/Web/API/WebRTC_API">WebRTC</a> compatible
      </th>
      <td>Yes</td>
    </tr>
    <tr>
