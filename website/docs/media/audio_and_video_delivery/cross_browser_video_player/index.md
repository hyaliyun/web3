...
> [!NOTE]
> For more information and ideas on progress bars and buffering feedback, read [Media buffering, seeking, and time ranges](/Web/Media/Audio_and_video_delivery/buffering_seeking_time_ranges).
...
- [Using HTML audio and video](/Learn/HTML/Multimedia_and_embedding/Video_and_audio_content) for more techniques
- [Media formats supported by the HTML audio and video elements](/Web/Media/Formats)
