...
> [!NOTE]
> You can find a guide to encoding HLS and MPEG-DASH for use on the web at [Setting up adaptive streaming media sources](/Web/Media/Audio_and_video_delivery/Setting_up_adaptive_streaming_media_sources).
