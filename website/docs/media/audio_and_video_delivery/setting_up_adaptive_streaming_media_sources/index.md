...
1. Your client or server does not support [range requests](/Web/HTTP/Range_requests)
...
> [!NOTE]
> If you use WebM you can use the methods shown in this tutorial [DASH Adaptive Streaming for HTML 5 Video](/Web/Media/DASH_Adaptive_Streaming_for_HTML_5_Video).
