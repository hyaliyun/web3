...
TimeRanges are a series of non-overlapping ranges of time, with start and stop times. ([learn more about TimeRanges](/Web/API/TimeRanges)).
...
For more information on byte range requests see [HTTP range requests](/Web/HTTP/Range_requests).
