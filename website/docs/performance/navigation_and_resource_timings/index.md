...
With the metrics above, and a bit of math, we can calculate many important metrics like [time to first byte](/Glossary/Time_to_first_byte), page load time, dns lookup, and whether the connection is secure.
