...
With [CSS animations](/Web/CSS/CSS_animations/Using_CSS_animations) you specify a number of [keyframes](/Web/CSS/@keyframes), each of which uses CSS to define the appearance of the element at a particular stage of the animation. The browser creates the animation as a transition from each keyframe to the next.
