...
**DNS resolution** is the time it took to do the {{glossary('DNS')}} lookup. The greater the number of [hostnames](/Web/API/URL/hostname), the more DNS lookups need to be done.
