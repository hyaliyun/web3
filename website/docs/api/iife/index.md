...
1. The first is the anonymous function with lexical scope enclosed within the [grouping operator](/Web/JavaScript/Reference/Operators/Grouping) `()`. This prevents accessing variables within the IIFE idiom as well as polluting the global scope.
...
An [`async`](/Web/JavaScript/Reference/Operators/async_function) IIFE allows you to use [`await`](/Web/JavaScript/Reference/Operators/await) and [`for-await`](/Web/JavaScript/Reference/Statements/for-await...of) even in older browsers and JavaScript runtimes that have no [top-level await](/Web/JavaScript/Reference/Operators/await#top_level_await):
