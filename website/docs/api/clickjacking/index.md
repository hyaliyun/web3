...
Clickjacking can be prevented by implementing a [Content Security Policy (frame-ancestors)](/Web/HTTP/Headers/Content-Security-Policy/frame-ancestors) and implementing [Set-Cookie attributes](/Web/HTTP/Headers/Set-Cookie#attributes).

## See also

- [Web security: clickjacking protection](/Web/Security/Practical_implementation_guides/Clickjacking)
