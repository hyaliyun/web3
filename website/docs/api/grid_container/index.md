...
Using the value `grid` or `inline-grid` on an element turns it into a **grid container** using [CSS grid layout](/Web/CSS/CSS_grid_layout), and any direct children of this element become grid items.
