...
The typed arrays guide provides an example that [converts any number to its binary representation under the given endianness](/Web/JavaScript/Guide/Typed_arrays#dataview).
