...
| --------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| {{Glossary("null")}}        | Null      | The keyword [`null`](/Web/JavaScript/Reference/Operators/null) — the absence of any value.                                               |
| {{Glossary("undefined")}}   | Undefined | [`undefined`](/Web/JavaScript/Reference/Global_Objects/undefined) — the primitive value.                                                 |
| `false`                     | Boolean   | The keyword [`false`](/Web/JavaScript/Reference/Lexical_grammar#reserved_words).                                                         |
| {{Glossary("NaN")}}         | Number    | [`NaN`](/Web/JavaScript/Reference/Global_Objects/NaN) — not a number.                                                                    |
...
| `""`                        | String    | Empty [string](/Web/JavaScript/Reference/Global_Objects/String) value, also including `''` and ` `` `.                                   |
...
- Related glossary terms:
  ...
  - {{Glossary("Boolean")}}
- [Boolean coercion](/Web/JavaScript/Reference/Global_Objects/Boolean#boolean_coercion)
