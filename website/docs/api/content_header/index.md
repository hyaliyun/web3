...
**Content headers** are the group of [HTTP headers](/Web/HTTP/Headers) that describe the content of the body of an HTTP message, after any message framing in the body has been removed.
