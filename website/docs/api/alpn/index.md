...
- [Performance resource timing `nextHopProtocol`](/Web/API/PerformanceResourceTiming/nextHopProtocol) property
- [PerformanceObserver API](/Web/API/PerformanceObserver)
