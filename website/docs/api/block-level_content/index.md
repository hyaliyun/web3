...
> [!NOTE]
> The above behavior of block layout changes if the containing block's [`writing-mode`](/Web/CSS/writing-mode) is set to value other than [the default value](/Web/CSS/writing-mode#formal_definition).
...
- {{cssxref("display")}}
- [`writing-mode`](/Web/CSS/writing-mode)
