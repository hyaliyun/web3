...
> [!NOTE]
> Setting cookies with the [`SameSite`](/Web/Security/Practical_implementation_guides/Cookies#samesite) directive is also useful in clickjacking cases that rely on the user being authenticated.
